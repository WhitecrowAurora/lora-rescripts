...
const E = s("p", null, "v1.0.2", -1);
const h = r(
  `<p align="center"><strong>Fork from</strong> 秋葉 <a href="https://github.com/Akegarasu/lora-scripts" target="_blank" rel="noopener noreferrer">aaaki/lora-scripts</a></p><p align="center"><strong>Modify By</strong> <a href="https://github.com/WhitecrowAurora/lora-rescripts" target="_blank" rel="noopener noreferrer">Lulynx</a></p><h3 id="更新日志" tabindex="-1"><a class="header-anchor" href="#更新日志" aria-hidden="true">#</a> 更新日志</h3><h4 id="v1-0-2" tabindex="-1"><a class="header-anchor" href="#v1-0-2" aria-hidden="true">#</a> v1.0.2</h4><ul><li>优化了便携启动流程和项目内 Python 运行时处理。</li><li>修复了标签编辑器启动、依赖兼容和深浅色主题一致性问题。</li><li>改进了训练兼容性，包括配置解析、SDXL 检查点加载以及 xformers 到 sdpa 的自动降级。</li><li>更新了打包分发说明、文档和下载引导。</li></ul>`,
  5
);
