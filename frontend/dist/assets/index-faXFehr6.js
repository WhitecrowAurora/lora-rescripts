var Pt=Object.defineProperty;var Nt=(e,t,a)=>t in e?Pt(e,t,{enumerable:!0,configurable:!0,writable:!0,value:a}):e[t]=a;var $=(e,t,a)=>Nt(e,typeof t!="symbol"?t+"":t,a);(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))n(s);new MutationObserver(s=>{for(const i of s)if(i.type==="childList")for(const r of i.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&n(r)}).observe(document,{childList:!0,subtree:!0});function a(s){const i={};return s.integrity&&(i.integrity=s.integrity),s.referrerPolicy&&(i.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?i.credentials="include":s.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function n(s){if(s.ep)return;s.ep=!0;const i=a(s);fetch(s.href,i)}})();const _e="".replace(/\/$/,"");async function P(e){const t=await fetch(`${_e}${e}`,{headers:{Accept:"application/json"}});if(!t.ok)throw new Error(`${t.status} ${t.statusText}`);return await t.json()}async function N(e,t){const a=await fetch(`${_e}${e}`,{method:"POST",headers:{Accept:"application/json","Content-Type":"application/json"},body:JSON.stringify(t)});if(!a.ok)throw new Error(`${a.status} ${a.statusText}`);return await a.json()}async function Rt(e){const t=await fetch(`${_e}${e}`,{headers:{Accept:"application/json"}});if(!t.ok)throw new Error(`${t.status} ${t.statusText}`);return await t.json()}async function Ct(){return P("/api/schemas/hashes")}async function xe(){return P("/api/schemas/all")}async function nt(){return P("/api/presets")}async function Dt(){return P("/api/config/saved_params")}async function Bt(){return P("/api/config/summary")}async function we(){return P("/api/tasks")}async function it(e){return P(`/api/tasks/terminate/${e}`)}async function rt(){return P("/api/graphic_cards")}async function ot(){return Rt("/api/tageditor_status")}async function qt(){return P("/api/scripts")}async function Ft(e){return N("/api/dataset/analyze",e)}async function jt(e){return N("/api/dataset/masked_loss_audit",e)}async function Ot(){return P("/api/interrogators")}async function O(e){var a;const t=await P(`/api/pick_file?picker_type=${encodeURIComponent(e)}`);if(t.status!=="success"||!((a=t.data)!=null&&a.path))throw new Error(t.message||"File picker did not return a path.");return t.data.path}async function Ht(e){return N("/api/interrogate",e)}async function Mt(e){return N("/api/captions/cleanup/preview",e)}async function zt(e){return N("/api/captions/cleanup/apply",e)}async function Xt(e){return N("/api/captions/backups/create",e)}async function Ut(e){return N("/api/captions/backups/list",e)}async function Wt(e){return N("/api/captions/backups/restore",e)}async function Vt(e){return N("/api/run",e)}async function Gt(e){return N("/api/train/preflight",e)}async function Kt(e){return N("/api/train/sample_prompt",e)}function h(e,t){const a=document.querySelector(`#${e}`);a&&(a.textContent=t)}function g(e,t){const a=document.querySelector(`#${e}`);a&&(a.innerHTML=t)}function X(e,t){const a=document.querySelector(`#${e}`);a&&(a.textContent=t)}const lt=[{route:"index.html",title:"SD-reScripts | SD training UI",section:"core",status:"migrate-first",notes:"Landing page and main navigation entry. Good first candidate for source migration."},{route:"lora/index.html",title:"LoRA training index",section:"training",status:"migrate-first",notes:"Top-level training model selector page.",schemaHints:["shared"]},{route:"lora/sdxl.html",title:"SDXL LoRA training",section:"training",status:"migrate-first",notes:"Primary training page currently used most often.",schemaHints:["sdxl-lora","shared"]},{route:"lora/flux.html",title:"Flux LoRA training",section:"training",status:"migrate-first",notes:"Now mirrored by the shared source-side training bridge.",schemaHints:["flux-lora","shared"]},{route:"lora/sd3.html",title:"SD3 training",section:"training",status:"migrate-first",notes:"Now mirrored by the shared source-side training bridge.",schemaHints:["sd3-lora","shared"]},{route:"lora/controlnet.html",title:"SD ControlNet training",section:"training",status:"migrate-first",notes:"Now mirrored by the shared source-side training bridge.",schemaHints:["sd-controlnet","shared"]},{route:"lora/sdxl-controlnet.html",title:"SDXL ControlNet training",section:"training",status:"migrate-first",notes:"Now mirrored by the shared source-side training bridge.",schemaHints:["sdxl-controlnet","shared"]},{route:"lora/sdxl-lllite.html",title:"SDXL LLLite training",section:"training",status:"migrate-first",notes:"Specialized SDXL conditioning route now mirrored by the shared source-side bridge.",schemaHints:["sdxl-controlnet-lllite","shared"]},{route:"lora/flux-controlnet.html",title:"Flux ControlNet training",section:"training",status:"migrate-first",notes:"Now mirrored by the shared source-side training bridge.",schemaHints:["flux-controlnet","shared"]},{route:"lora/basic.html",title:"LoRA basic mode",section:"training",status:"legacy-dist",notes:"Legacy beginner-mode training route.",schemaHints:["lora-basic","shared"]},{route:"lora/master.html",title:"LoRA expert mode",section:"training",status:"legacy-dist",notes:"Legacy expert-mode training route.",schemaHints:["lora-master","shared"]},{route:"lora/params.html",title:"Training parameter reference",section:"training",status:"migrate-first",notes:"Mostly explanatory UI. Lower risk to recreate cleanly."},{route:"lora/tools.html",title:"LoRA tools",section:"tools",status:"migrate-first",notes:"Tool launcher route for merge, resize, interrogate and conversion flows."},{route:"dreambooth/index.html",title:"Dreambooth training",section:"training",status:"migrate-first",notes:"Now mirrored by the shared source-side training bridge for Dreambooth and SDXL full finetune.",schemaHints:["dreambooth","shared"]},{route:"tagger.html",title:"Tagger tool",section:"tools",status:"migrate-first",notes:"Standalone caption/tag generation route that talks to backend APIs.",schemaHints:["tagger"]},{route:"tageditor.html",title:"Tag editor proxy page",section:"tools",status:"migrate-first",notes:"Wrapper page with progress/failure states. Good candidate to reimplement cleanly."},{route:"task.html",title:"Task monitor",section:"system",status:"migrate-first",notes:"Task status page backed by /api/tasks."},{route:"tensorboard.html",title:"TensorBoard proxy page",section:"system",status:"migrate-first",notes:"Wrapper/proxy page. Safer than schema-heavy form routes."},{route:"other/settings.html",title:"Settings page",section:"system",status:"migrate-first",notes:"Static/system page that should be easy to recreate in source form."},{route:"other/about.html",title:"About page",section:"core",status:"migrate-first",notes:"Mostly branding and release notes. Best low-risk migration target."},{route:"404.html",title:"Fallback page",section:"core",status:"legacy-dist",notes:"Can be replaced after the main router is rebuilt."}];function o(e){return String(e).replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}function H(e){return JSON.parse(JSON.stringify(e))}function he(e=new Date){return e.toISOString().replaceAll(":","-").replaceAll(".","-")}function Jt(e){if(e.length===0){g("schema-browser","<p>No schemas returned.</p>");return}const t=e.map(a=>{var s;const n=((s=a.schema.split(/\r?\n/).find(i=>i.trim().length>0))==null?void 0:s.trim())||"No preview available.";return`
      ...
      `}).join("");g("schema-browser",t)}function Yt(e){const t=new Set(lt.flatMap(i=>i.schemaHints??[])),a=new Set(e.map(i=>i.name)),n=[...t].filter(i=>a.has(i)).sort(),s=e.map(i=>i.name).filter(i=>!t.has(i)).sort();g("schema-mapped",n.length?n.map(i=>`<span class="coverage-pill">${o(i)}</span>`).join(""):"<p>No mapped schema hints yet.</p>"),g("schema-unmapped",s.length?s.map(i=>`<span class="coverage-pill coverage-pill-muted">${o(i)}</span>`).join(""):"<p>All schemas are represented in the current route hints.</p>")}function Zt(e){if(!e.length){g("training-catalog","<p>No training routes were registered.</p>");return}const t=e.length,a=e.filter(l=>l.schemaAvailable).length,n=e.filter(l=>l.presetCount>0).length,s=e.filter(l=>l.localRecipeCount>0).length,i=new Map,r=new Map;for(const l of e){i.set(l.family,(i.get(l.family)??0)+1);for(const c of l.capabilities)r.set(c,(r.get(c)??0)+1)}const d=`
    ...
    <div class="coverage-list training-catalog-capabilities">
      ${[...r.entries()].sort((l,c)=>c[1]-l[1]||l[0].localeCompare(c[0])).map(([l,c])=>`<span class="coverage-pill">${o(l)} <strong>${c}</strong></span>`).join("")}
    </div>
  `,u=e.map(l=>`
        <article class="training-catalog-card" data-family="${o(l.family)}">
          ...
          <div class="coverage-list training-catalog-capability-row">
            ${l.capabilities.map(c=>`<span class="coverage-pill coverage-pill-muted">${o(c)}</span>`).join("")}
          </div>
        </article>
      `).join("");g("training-catalog",`
      ${d}
      <div class="training-catalog-grid">${u}</div>
    `)}function Qt(e){if(e.length===0){g("task-table-container","<p>No tasks currently tracked.</p>");return}const t=e.map(a=>`
        <tr>
    ...
    `)}function ea(e){if(e.length===0){g("tools-browser","<p>No scripts returned.</p>");return}const t=e.map(a=>`
    ...
    `:"",n=e.folders.length?e.folders.map(s=>`
      ...
      <section class="dataset-analysis-columns">
        ...
        <article class="dataset-analysis-block">
          ...
          <h3>Top tags</h3>
          ${ct(e.top_tags,"No caption tags found yet.")}
        </article>
        <article class="dataset-analysis-block">
          <p class="panel-kicker">images</p>
          <h3>Top resolutions</h3>
          ${le(e.top_resolutions,"No resolution data collected.")}
        </article>
        <article class="dataset-analysis-block">
          <p class="panel-kicker">mix</p>
          <h3>Orientation + formats</h3>
          <div>${le(e.orientation_counts,"No orientation data.")}</div>
          <div class="dataset-analysis-sublist">${le(e.image_extensions,"No image extension data.")}</div>
        </article>
      </section>
      <section class="dataset-analysis-columns">
        <article class="dataset-analysis-block">
    ...
    `)}function aa(e,t="masked-loss-audit-results"){const a=[{label:"Images",value:e.summary.image_count},{label:"Alpha channel images",value:e.summary.alpha_channel_image_count},{label:"Usable masks",value:e.summary.usable_mask_image_count},{label:"Soft alpha masks",value:e.summary.soft_alpha_image_count},{label:"Binary alpha masks",value:e.summary.binary_alpha_image_count},{label:"Avg masked area",value:ee(e.summary.average_mask_coverage)},{label:"Avg alpha weight",value:ee(e.summary.average_alpha_weight)}],n=e.warnings.length?`
      <article class="dataset-analysis-block dataset-analysis-warning">
        <p class="panel-kicker">warnings</p>
        <ul class="dataset-analysis-list-plain">
          ${e.warnings.map(s=>`<li>${o(s)}</li>`).join("")}
    ...
    `:"",s=e.samples.length?e.samples.map(i=>`
      ...
      <section class="dataset-analysis-columns">
        ...
        <article class="dataset-analysis-block">
          ...
          <h3>Rule summary</h3>
          ${ct([e.options.dedupe_tags?{name:"dedupe tags",count:1}:null,e.options.sort_tags?{name:"sort tags",count:1}:null,e.options.use_regex?{name:"regex replace",count:1}:null].filter(Boolean),"No boolean cleanup switches enabled.")}
          <div class="dataset-analysis-sublist">
            <h4>Remove tags</h4>
    ...
    `)}function na(e,t,a="caption-backup-results"){if(!e.length){g(a,`
        <article class="dataset-analysis-block">
      ...
      `);return}const n=e.map(s=>`
        <article class="dataset-analysis-block ${s.archive_name===t?"dataset-analysis-selected":""}">
          ...
          <p>Caption files: <strong>${s.file_count}</strong> · Archive size: <strong>${ra(s.archive_size)}</strong></p>
          <p>Extension: <code>${o(s.caption_extension||".txt")}</code> · Recursive: <strong>${s.recursive?"yes":"no"}</strong></p>
        </article>
      `).join("");g(a,`<div class="dataset-analysis-stack">${n}</div>`)}function ia(e,t="caption-backup-results"){const a=e.warnings.length?`
      <article class="dataset-analysis-block dataset-analysis-warning">
        <p class="panel-kicker">warnings</p>
        <ul class="dataset-analysis-list-plain">
  ...
  `:`<p>${o(t)}</p>`}function ee(e){return`${(e*100).toFixed(1)}%`}function ra(e){return e<1024?`${e} B`:e<1024**2?`${(e/1024).toFixed(1)} KB`:e<1024**3?`${(e/1024**2).toFixed(1)} MB`:`${(e/1024**3).toFixed(2)} GB`}function dt(e){return e.length===0?"No cards reported yet.":e.map((t,a)=>`GPU ${t.index??t.id??a}: ${t.name}`).join(" | ")}function oa(e){if(e.length===0)return"No tasks currently tracked.";const t=e.filter(a=>a.status&&!["FINISHED","TERMINATED","FAILED"].includes(String(a.status))).length;return`${e.length} tracked, ${t} active`}function la(e){var a;const t=(a=e.detail)==null?void 0:a.trim();return t?`${e.status} - ${t}`:e.status}const F="#/workspace",j=[{id:"overview",label:"Workspace",section:"overview",hash:F,description:"Source migration dashboard and live backend diagnostics."},{id:"about",label:"About",section:"phase1",hash:"#/about",description:"Rebuild branding and release notes in source form."},{id:"settings",label:"Settings",section:"phase1",hash:"#/settings",description:"Read config summary and saved parameter state from the backend."},{id:"tasks",label:"Tasks",section:"phase1",hash:"#/tasks",description:"Inspect and manage task execution state."},{id:"tageditor",label:"Tag Editor",section:"phase1",hash:"#/tageditor",description:"Track startup status and future proxy behavior."},{id:"tensorboard",label:"TensorBoard",section:"phase1",hash:"#/tensorboard",description:"Prepare a cleaner source-side wrapper for TensorBoard access."},{id:"tools",label:"Tools",section:"phase1",hash:"#/tools",description:"Migrate script-launch and utility entry points from the legacy tools page."},{id:"schema-bridge",label:"Schema Bridge",section:"reference",hash:"#/schema-bridge",description:"Evaluate current schema DSL into a source-side explorer and prototype form renderer."},{id:"sdxl-train",label:"SDXL Train",section:"reference",hash:"#/sdxl-train",description:"First source-side training page powered by the schema bridge and current `/api/run` backend."},{id:"flux-train",label:"Flux Train",section:"reference",hash:"#/flux-train",description:"Source-side Flux LoRA training route built on the shared schema bridge and launch pipeline."},{id:"sd3-train",label:"SD3 Train",section:"reference",hash:"#/sd3-train",description:"Source-side SD3 LoRA training route using the same normalized payload workflow."},{id:"sd3-finetune-train",label:"SD3 Finetune",section:"reference",hash:"#/sd3-finetune-train",description:"Source-side SD3 finetune route on the shared training bridge."},{id:"dreambooth-train",label:"Dreambooth",section:"reference",hash:"#/dreambooth-train",description:"Source-side Dreambooth and SDXL full-finetune route on the shared schema bridge."},{id:"flux-finetune-train",label:"Flux Finetune",section:"reference",hash:"#/flux-finetune-train",description:"Source-side Flux full-finetune route using the shared launch workflow."},{id:"sd-controlnet-train",label:"SD ControlNet",section:"reference",hash:"#/sd-controlnet-train",description:"Source-side SD ControlNet training route using the shared launch flow."},{id:"sdxl-controlnet-train",label:"SDXL ControlNet",section:"reference",hash:"#/sdxl-controlnet-train",description:"Source-side SDXL ControlNet training route using the shared launch flow."},{id:"flux-controlnet-train",label:"Flux ControlNet",section:"reference",hash:"#/flux-controlnet-train",description:"Source-side Flux ControlNet training route using the shared launch flow."},{id:"sdxl-lllite-train",label:"SDXL LLLite",section:"reference",hash:"#/sdxl-lllite-train",description:"Source-side SDXL ControlNet-LLLite training route on the shared training bridge."},{id:"sd-ti-train",label:"SD TI",section:"reference",hash:"#/sd-ti-train",description:"Source-side SD textual inversion route on the shared training bridge."},{id:"xti-train",label:"SD XTI",section:"reference",hash:"#/xti-train",description:"Source-side SD XTI textual inversion route on the shared training bridge."},{id:"sdxl-ti-train",label:"SDXL TI",section:"reference",hash:"#/sdxl-ti-train",description:"Source-side SDXL textual inversion route on the shared training bridge."},{id:"anima-train",label:"Anima LoRA",section:"reference",hash:"#/anima-train",description:"Source-side Anima LoRA training route using the shared launch flow."},{id:"anima-finetune-train",label:"Anima Finetune",section:"reference",hash:"#/anima-finetune-train",description:"Source-side Anima finetune route using the shared launch flow."},{id:"lumina-train",label:"Lumina LoRA",section:"reference",hash:"#/lumina-train",description:"Source-side Lumina LoRA training route using the shared launch flow."},{id:"lumina-finetune-train",label:"Lumina Finetune",section:"reference",hash:"#/lumina-finetune-train",description:"Source-side Lumina finetune route using the shared launch flow."},{id:"hunyuan-image-train",label:"Hunyuan Image",section:"reference",hash:"#/hunyuan-image-train",description:"Source-side Hunyuan Image LoRA training route using the shared launch flow."}],pt=new Set(j.map(e=>e.hash)),ut={"/index.html":F,"/index.md":F,"/404.html":F,"/404.md":F,"/task.html":"#/tasks","/task.md":"#/tasks","/tageditor.html":"#/tageditor","/tageditor.md":"#/tageditor","/tagger.html":"#/tageditor","/tagger.md":"#/tageditor","/tensorboard.html":"#/tensorboard","/tensorboard.md":"#/tensorboard","/other/about.html":"#/about","/other/about.md":"#/about","/other/settings.html":"#/settings","/other/settings.md":"#/settings","/dreambooth/index.html":"#/dreambooth-train","/dreambooth/index.md":"#/dreambooth-train","/lora/index.html":"#/sdxl-train","/lora/index.md":"#/sdxl-train"},ca=Object.keys(ut).sort((e,t)=>t.length-e.length);function $e(e){const t=e.replace(/\/+$/,"");return t.length>0?`${t}/`:"/"}function da(e){switch(e){case"flux":return"#/flux-train";case"flux-finetune":return"#/flux-finetune-train";case"sd3":return"#/sd3-train";case"sd3-finetune":return"#/sd3-finetune-train";case"controlnet":return"#/sd-controlnet-train";case"sdxl-controlnet":return"#/sdxl-controlnet-train";case"flux-controlnet":return"#/flux-controlnet-train";case"sdxl-lllite":return"#/sdxl-lllite-train";case"tools":return"#/tools";case"basic":case"master":case"params":case"sdxl":return"#/sdxl-train";case"sdxl-ti":return"#/sdxl-ti-train";case"ti":return"#/sd-ti-train";case"xti":return"#/xti-train";case"anima":return"#/anima-train";case"anima-finetune":return"#/anima-finetune-train";case"hunyuan":return"#/hunyuan-image-train";case"lumina":return"#/lumina-train";case"lumina-finetune":return"#/lumina-finetune-train";default:return null}}function pa(e){const t=e.match(/^(.*)\/lora\/([^/]+)\.(?:html|md)$/i);if(!t)return null;const[,a,n]=t,s=da(n.toLowerCase());return s?{hash:s,canonicalRootPath:$e(a)}:null}function ua(e){const t=e.toLowerCase();for(const a of ca)if(t.endsWith(a))return{hash:ut[a],canonicalRootPath:$e(e.slice(0,e.length-a.length))};return pa(e)}function De(e,t){const a=`${e}${window.location.search}${t}`,n=`${window.location.pathname}${window.location.search}${window.location.hash}`;a!==n&&window.history.replaceState(null,"",a)}function ha(){const e=pt.has(window.location.hash)?window.location.hash:F;return j.find(t=>t.hash===e)??j[0]}function ma(){if(pt.has(window.location.hash))return;const e=ua(window.location.pathname);if(e){De(e.canonicalRootPath,e.hash);return}De($e(window.location.pathname||"/"),F)}const me={"sdxl-train":{routeId:"sdxl-train",schemaName:"sdxl-lora",prefix:"sdxl",modelLabel:"SDXL",presetTrainTypes:["sdxl-lora"]},"flux-train":{routeId:"flux-train",schemaName:"flux-lora",prefix:"flux",modelLabel:"Flux",presetTrainTypes:["flux-lora"]},"sd3-train":{routeId:"sd3-train",schemaName:"sd3-lora",prefix:"sd3",modelLabel:"SD3",presetTrainTypes:["sd3-lora"]},"sd3-finetune-train":{routeId:"sd3-finetune-train",schemaName:"sd3-finetune",prefix:"sd3-finetune",modelLabel:"SD3 Finetune",presetTrainTypes:["sd3-finetune"]},"dreambooth-train":{routeId:"dreambooth-train",schemaName:"dreambooth",prefix:"dreambooth",modelLabel:"Dreambooth",presetTrainTypes:["dreambooth","sd-dreambooth","sdxl-finetune"]},"flux-finetune-train":{routeId:"flux-finetune-train",schemaName:"flux-finetune",prefix:"flux-finetune",modelLabel:"Flux Finetune",presetTrainTypes:["flux-finetune"]},"sd-controlnet-train":{routeId:"sd-controlnet-train",schemaName:"sd-controlnet",prefix:"sd-controlnet",modelLabel:"SD ControlNet",presetTrainTypes:["sd-controlnet"]},"sdxl-controlnet-train":{routeId:"sdxl-controlnet-train",schemaName:"sdxl-controlnet",prefix:"sdxl-controlnet",modelLabel:"SDXL ControlNet",presetTrainTypes:["sdxl-controlnet"]},"flux-controlnet-train":{routeId:"flux-controlnet-train",schemaName:"flux-controlnet",prefix:"flux-controlnet",modelLabel:"Flux ControlNet",presetTrainTypes:["flux-controlnet"]},"sdxl-lllite-train":{routeId:"sdxl-lllite-train",schemaName:"sdxl-controlnet-lllite",prefix:"sdxl-lllite",modelLabel:"SDXL LLLite",presetTrainTypes:["sdxl-controlnet-lllite"]},"sd-ti-train":{routeId:"sd-ti-train",schemaName:"sd-textual-inversion",prefix:"sd-ti",modelLabel:"SD Textual Inversion",presetTrainTypes:["sd-textual-inversion"]},"xti-train":{routeId:"xti-train",schemaName:"sd-textual-inversion-xti",prefix:"xti",modelLabel:"SD XTI",presetTrainTypes:["sd-textual-inversion-xti"]},"sdxl-ti-train":{routeId:"sdxl-ti-train",schemaName:"sdxl-textual-inversion",prefix:"sdxl-ti",modelLabel:"SDXL Textual Inversion",presetTrainTypes:["sdxl-textual-inversion"]},"anima-train":{routeId:"anima-train",schemaName:"anima-lora",prefix:"anima",modelLabel:"Anima LoRA",presetTrainTypes:["anima-lora"]},"anima-finetune-train":{routeId:"anima-finetune-train",schemaName:"anima-finetune",prefix:"anima-finetune",modelLabel:"Anima Finetune",presetTrainTypes:["anima-finetune"]},"lumina-train":{routeId:"lumina-train",schemaName:"lumina-lora",prefix:"lumina",modelLabel:"Lumina LoRA",presetTrainTypes:["lumina-lora"]},"lumina-finetune-train":{routeId:"lumina-finetune-train",schemaName:"lumina-finetune",prefix:"lumina-finetune",modelLabel:"Lumina Finetune",presetTrainTypes:["lumina-finetune"]},"hunyuan-image-train":{routeId:"hunyuan-image-train",schemaName:"hunyuan-image-lora",prefix:"hunyuan-image",modelLabel:"Hunyuan Image LoRA",presetTrainTypes:["hunyuan-image-lora"]}},ga=80,fa=100;function Se(){return typeof window<"u"?window:null}function Te(e,t){const a=Se();if(!a)return t;try{const n=a.localStorage.getItem(e);return n?JSON.parse(n):t}catch{return t}}function Le(e,t){const a=Se();a&&a.localStorage.setItem(e,JSON.stringify(t))}function ht(e){return`source-training-autosave-${e}`}function mt(e){return`source-training-history-${e}`}function gt(e){return`source-training-recipes-${e}`}function ba(e){return Te(ht(e),null)}function ya(e,t){Le(ht(e),t)}function B(e){return Te(mt(e),[])}function te(e,t){Le(mt(e),t)}function E(e){return Te(gt(e),[])}function V(e,t){Le(gt(e),t)}function ft(e){return e.slice(0,ga)}function Ie(e){return e.slice(0,fa)}function z(e,t,a="text/plain;charset=utf-8"){const n=Se();if(!n)return;const s=new Blob([t],{type:a}),i=URL.createObjectURL(s),r=n.document.createElement("a");r.href=i,r.download=e,r.click(),URL.revokeObjectURL(i)}async function va(){var d,u,l,c,p,m,f,k;const e=await Promise.allSettled([Ct(),nt(),we(),rt(),ot(),xe()]),[t,a,n,s,i,r]=e;if(t.status==="fulfilled"){const _=((d=t.value.data)==null?void 0:d.schemas)??[];h("diag-schemas-title",`${_.length} schema hashes loaded`),h("diag-schemas-detail",_.slice(0,4).map(A=>A.name).join(", ")||"No schema names returned.")}else h("diag-schemas-title","Schema hash request failed"),h("diag-schemas-detail",t.reason instanceof Error?t.reason.message:"Unknown error");if(a.status==="fulfilled"){const _=((u=a.value.data)==null?void 0:u.presets)??[];h("diag-presets-title",`${_.length} presets loaded`),h("diag-presets-detail","Source migration can reuse preset grouping later.")}else h("diag-presets-title","Preset request failed"),h("diag-presets-detail",a.reason instanceof Error?a.reason.message:"Unknown error");if(n.status==="fulfilled"){const _=((l=n.value.data)==null?void 0:l.tasks)??[];h("diag-tasks-title","Task manager reachable"),h("diag-tasks-detail",oa(_))}else h("diag-tasks-title","Task request failed"),h("diag-tasks-detail",n.reason instanceof Error?n.reason.message:"Unknown error");if(s.status==="fulfilled"){const _=((c=s.value.data)==null?void 0:c.cards)??[],A=(p=s.value.data)==null?void 0:p.xformers,D=A?`xformers: ${A.installed?"installed":"missing"}, ${A.supported?"supported":"fallback"}`:"xformers info unavailable";h("diag-gpu-title",`${_.length} GPU entries reachable`),h("diag-gpu-detail",`${dt(_)} | ${D}`)}else h("diag-gpu-title","GPU request failed"),h("diag-gpu-detail",s.reason instanceof Error?s.reason.message:"Unknown error");if(i.status==="fulfilled"?(h("diag-tageditor-title","Tag editor status reachable"),h("diag-tageditor-detail",la(i.value))):(h("diag-tageditor-title","Tag editor status request failed"),h("diag-tageditor-detail",i.reason instanceof Error?i.reason.message:"Unknown error")),r.status==="fulfilled"){const _=((m=r.value.data)==null?void 0:m.schemas)??[];Jt(_),Yt(_),Be(_,a.status==="fulfilled"?((f=a.value.data)==null?void 0:f.presets)??[]:[])}else g("schema-browser",`<p>${r.reason instanceof Error?r.reason.message:"Schema inventory request failed."}</p>`),Be([],a.status==="fulfilled"?((k=a.value.data)==null?void 0:k.presets)??[]:[])}function ka(e){return e.includes("controlnet")?"ControlNet":e.includes("textual-inversion")||e.includes("xti")?"Textual Inversion":e.includes("finetune")||e==="dreambooth"?"Finetune":"LoRA"}function _a(e,t,a){const n=["preflight","prompt workspace","history","recipes"];return t.includes("resume:")&&n.push("resume"),(t.includes("prompt_file")||t.includes("positive_prompts"))&&n.push("sample prompts"),t.includes("validation_split")&&n.push("validation"),t.includes("masked_loss")&&n.push("masked loss"),t.includes("save_state")&&n.push("save state"),t.includes("conditioning_data_dir")&&n.push("conditioning"),a==="Textual Inversion"&&n.push("embeddings"),a==="ControlNet"&&n.push("controlnet"),e.routeId.startsWith("sdxl")&&n.push("experimental clip-skip"),[...new Set(n)]}function Be(e,t){const a=new Map(e.map(s=>[s.name,String(s.schema??"")])),n=Object.values(me).map(s=>{const i=j.find(c=>c.id===s.routeId),r=ka(s.schemaName),d=a.get(s.schemaName)??"",u=t.filter(c=>{const m=(c.metadata??{}).train_type;return typeof m!="string"||m.trim().length===0?!1:s.presetTrainTypes.includes(m)}).length,l=E(s.routeId).length;return{routeId:s.routeId,title:(i==null?void 0:i.label)??s.modelLabel,routeHash:(i==null?void 0:i.hash)??"#/workspace",schemaName:s.schemaName,modelLabel:s.modelLabel,family:r,presetCount:u,localRecipeCount:l,schemaAvailable:a.has(s.schemaName),capabilities:_a(s,d,r)}}).sort((s,i)=>s.family.localeCompare(i.family)||s.title.localeCompare(i.title));Zt(n)}async function xa(){const[e,t]=await Promise.allSettled([Bt(),Dt()]);if(e.status==="fulfilled"){const a=e.value.data;h("settings-summary-title",`${(a==null?void 0:a.saved_param_count)??0} remembered param groups`),g("settings-summary-body",`
      ...
      `)}else h("settings-summary-title","Config summary request failed"),h("settings-summary-body",e.reason instanceof Error?e.reason.message:"Unknown error");if(t.status==="fulfilled"){const a=t.value.data??{},n=Object.keys(a);h("settings-params-title",`${n.length} saved param entries`),g("settings-params-body",n.length?`<div class="coverage-list">${n.map(s=>`<span class="coverage-pill coverage-pill-muted">${o(s)}</span>`).join("")}</div>`:"<p>No saved params returned.</p>")}else h("settings-params-title","Saved params request failed"),h("settings-params-body",t.reason instanceof Error?t.reason.message:"Unknown error")}const wa="".replace(/\/$/,""),$a=wa||"";function R(e){return/^https?:\/\//.test(e)?e:(e.startsWith("/")||(e=`/${e}`),`${$a}${e}`)}async function Sa(){try{const e=await ot();h("tag-editor-status-title",`Current status: ${e.status}`),g("tag-editor-status-body",`
      ...
      `)}catch(e){h("tag-editor-status-title","Tag editor status request failed"),h("tag-editor-status-body",e instanceof Error?e.message:"Unknown error")}}async function Ta(){var e;Ia(),La(),await Aa(),Ea(),Pa();try{const a=((e=(await qt()).data)==null?void 0:e.scripts)??[];h("tools-summary-title",`${a.length} launcher scripts available`),g("tools-summary-body",`
      ...
      `),ea(a)}catch(t){h("tools-summary-title","Script inventory request failed"),h("tools-summary-body",t instanceof Error?t.message:"Unknown error"),g("tools-browser","<p>Tool inventory failed to load.</p>")}}function La(){const e=Ra();e&&(e.browseButton.addEventListener("click",async()=>{h("masked-loss-audit-status","Opening folder picker...");try{e.pathInput.value=await O("folder"),h("masked-loss-audit-status","Folder selected. Ready to inspect alpha masks.")}catch(t){h("masked-loss-audit-status",t instanceof Error?t.message:"Folder picker failed.")}}),e.runButton.addEventListener("click",()=>{Fe(e)}),e.pathInput.addEventListener("keydown",t=>{t.key==="Enter"&&(t.preventDefault(),Fe(e))}))}function Ia(){const e=Na();e&&(e.browseButton.addEventListener("click",async()=>{h("dataset-analysis-status","Opening folder picker...");try{e.pathInput.value=await O("folder"),h("dataset-analysis-status","Folder selected. Ready to analyze.")}catch(t){h("dataset-analysis-status",t instanceof Error?t.message:"Folder picker failed.")}}),e.runButton.addEventListener("click",()=>{qe(e)}),e.pathInput.addEventListener("keydown",t=>{t.key==="Enter"&&(t.preventDefault(),qe(e))}))}async function Aa(){var t;const e=Ca();if(e){e.browseButton.addEventListener("click",async()=>{h("batch-tagger-status","Opening folder picker...");try{e.pathInput.value=await O("folder"),h("batch-tagger-status","Folder selected. Ready to launch batch tagging.")}catch(a){h("batch-tagger-status",a instanceof Error?a.message:"Folder picker failed.")}}),e.runButton.addEventListener("click",()=>{je(e)}),e.pathInput.addEventListener("keydown",a=>{a.key==="Enter"&&(a.preventDefault(),je(e))});try{const a=await Ot(),n=((t=a.data)==null?void 0:t.interrogators)??[];if(!n.length)throw new Error("No interrogator models returned.");e.modelSelect.innerHTML=n.map(s=>{var d;const i=s.is_default||s.name===((d=a.data)==null?void 0:d.default)?" selected":"",r=s.kind==="cl"?"CL":"WD";return`<option value="${o(s.name)}"${i}>${o(s.name)} (${r})</option>`}).join(""),h("batch-tagger-status",`Loaded ${n.length} interrogator models.`)}catch(a){e.modelSelect.innerHTML='<option value="wd14-convnextv2-v2">wd14-convnextv2-v2 (WD)</option>',h("batch-tagger-status",a instanceof Error?a.message:"Failed to load interrogator inventory."),g("batch-tagger-results",`<article class="dataset-analysis-block dataset-analysis-warning"><p>${o(a instanceof Error?a.message:"Failed to load interrogator inventory.")}</p></article>`)}}}function Ea(){const e=Da();e&&(e.browseButton.addEventListener("click",async()=>{h("caption-cleanup-status","Opening folder picker...");try{e.pathInput.value=await O("folder"),h("caption-cleanup-status","Folder selected. Ready to preview cleanup.")}catch(t){h("caption-cleanup-status",t instanceof Error?t.message:"Folder picker failed.")}}),e.previewButton.addEventListener("click",()=>{ce(e,"preview")}),e.applyButton.addEventListener("click",()=>{ce(e,"apply")}),e.pathInput.addEventListener("keydown",t=>{t.key==="Enter"&&(t.preventDefault(),ce(e,"preview"))}))}function Pa(){const e=Ba();e&&(e.browseButton.addEventListener("click",async()=>{h("caption-backup-status","Opening folder picker...");try{e.pathInput.value=await O("folder"),h("caption-backup-status","Folder selected. Refreshing snapshots..."),await G(e)}catch(t){h("caption-backup-status",t instanceof Error?t.message:"Folder picker failed.")}}),e.refreshButton.addEventListener("click",()=>{G(e)}),e.createButton.addEventListener("click",()=>{qa(e)}),e.restoreButton.addEventListener("click",()=>{Fa(e)}),e.selectInput.addEventListener("change",()=>{G(e,e.selectInput.value||null)}))}function Na(){const e=document.querySelector("#dataset-analysis-path"),t=document.querySelector("#dataset-analysis-caption-extension"),a=document.querySelector("#dataset-analysis-top-tags"),n=document.querySelector("#dataset-analysis-sample-limit"),s=document.querySelector("#dataset-analysis-pick"),i=document.querySelector("#dataset-analysis-run");return!e||!t||!a||!n||!s||!i?null:{pathInput:e,captionExtensionInput:t,topTagsInput:a,sampleLimitInput:n,browseButton:s,runButton:i}}function Ra(){const e=document.querySelector("#masked-loss-audit-path"),t=document.querySelector("#masked-loss-audit-sample-limit"),a=document.querySelector("#masked-loss-audit-recursive"),n=document.querySelector("#masked-loss-audit-pick"),s=document.querySelector("#masked-loss-audit-run");return!e||!t||!a||!n||!s?null:{pathInput:e,sampleLimitInput:t,recursiveInput:a,browseButton:n,runButton:s}}function Ca(){const e=document.querySelector("#batch-tagger-path"),t=document.querySelector("#batch-tagger-model"),a=document.querySelector("#batch-tagger-threshold"),n=document.querySelector("#batch-tagger-character-threshold"),s=document.querySelector("#batch-tagger-conflict"),i=document.querySelector("#batch-tagger-additional-tags"),r=document.querySelector("#batch-tagger-backup-name"),d=document.querySelector("#batch-tagger-exclude-tags"),u=document.querySelector("#batch-tagger-recursive"),l=document.querySelector("#batch-tagger-replace-underscore"),c=document.querySelector("#batch-tagger-escape-tag"),p=document.querySelector("#batch-tagger-add-rating-tag"),m=document.querySelector("#batch-tagger-add-model-tag"),f=document.querySelector("#batch-tagger-auto-backup"),k=document.querySelector("#batch-tagger-pick"),_=document.querySelector("#batch-tagger-run");return!e||!t||!a||!n||!s||!i||!r||!d||!u||!l||!c||!p||!m||!f||!k||!_?null:{pathInput:e,modelSelect:t,thresholdInput:a,characterThresholdInput:n,conflictSelect:s,additionalTagsInput:i,backupNameInput:r,excludeTagsInput:d,recursiveInput:u,replaceUnderscoreInput:l,escapeTagInput:c,addRatingTagInput:p,addModelTagInput:m,autoBackupInput:f,browseButton:k,runButton:_}}function Da(){const e=document.querySelector("#caption-cleanup-path"),t=document.querySelector("#caption-cleanup-extension"),a=document.querySelector("#caption-cleanup-remove-tags"),n=document.querySelector("#caption-cleanup-prepend-tags"),s=document.querySelector("#caption-cleanup-append-tags"),i=document.querySelector("#caption-cleanup-search-text"),r=document.querySelector("#caption-cleanup-replace-text"),d=document.querySelector("#caption-cleanup-backup-name"),u=document.querySelector("#caption-cleanup-sample-limit"),l=document.querySelector("#caption-cleanup-recursive"),c=document.querySelector("#caption-cleanup-collapse-whitespace"),p=document.querySelector("#caption-cleanup-replace-underscore"),m=document.querySelector("#caption-cleanup-dedupe-tags"),f=document.querySelector("#caption-cleanup-sort-tags"),k=document.querySelector("#caption-cleanup-use-regex"),_=document.querySelector("#caption-cleanup-auto-backup"),A=document.querySelector("#caption-cleanup-pick"),D=document.querySelector("#caption-cleanup-preview"),W=document.querySelector("#caption-cleanup-apply");return!e||!t||!a||!n||!s||!i||!r||!d||!u||!l||!c||!p||!m||!f||!k||!_||!A||!D||!W?null:{pathInput:e,extensionInput:t,removeTagsInput:a,prependTagsInput:n,appendTagsInput:s,searchTextInput:i,replaceTextInput:r,backupNameInput:d,sampleLimitInput:u,recursiveInput:l,collapseWhitespaceInput:c,replaceUnderscoreInput:p,dedupeTagsInput:m,sortTagsInput:f,useRegexInput:k,autoBackupInput:_,browseButton:A,previewButton:D,applyButton:W}}function Ba(){const e=document.querySelector("#caption-backup-path"),t=document.querySelector("#caption-backup-extension"),a=document.querySelector("#caption-backup-name"),n=document.querySelector("#caption-backup-select"),s=document.querySelector("#caption-backup-recursive"),i=document.querySelector("#caption-backup-pre-restore"),r=document.querySelector("#caption-backup-pick"),d=document.querySelector("#caption-backup-create"),u=document.querySelector("#caption-backup-refresh"),l=document.querySelector("#caption-backup-restore");return!e||!t||!a||!n||!s||!i||!r||!d||!u||!l?null:{pathInput:e,extensionInput:t,nameInput:a,selectInput:n,recursiveInput:s,preRestoreInput:i,browseButton:r,createButton:d,refreshButton:u,restoreButton:l}}async function qe(e){const t=e.pathInput.value.trim();if(!t){h("dataset-analysis-status","Pick a dataset folder first."),g("dataset-analysis-results",'<p class="dataset-analysis-empty">No folder selected yet.</p>');return}e.browseButton.disabled=!0,e.runButton.disabled=!0,h("dataset-analysis-status","Analyzing dataset..."),g("dataset-analysis-results",'<p class="dataset-analysis-empty">Scanning images, captions, and tags...</p>');try{const a=await Ft({path:t,caption_extension:e.captionExtensionInput.value.trim()||".txt",top_tags:ae(e.topTagsInput.value,40),sample_limit:ae(e.sampleLimitInput.value,8)});if(a.status!=="success"||!a.data)throw new Error(a.message||"Dataset analysis returned no data.");h("dataset-analysis-status",`Scanned ${a.data.summary.image_count} images across ${a.data.summary.dataset_folder_count} dataset folder(s).`),ta(a.data)}catch(a){h("dataset-analysis-status",a instanceof Error?a.message:"Dataset analysis failed."),g("dataset-analysis-results",`<article class="dataset-analysis-block dataset-analysis-warning"><p>${o(a instanceof Error?a.message:"Dataset analysis failed.")}</p></article>`)}finally{e.browseButton.disabled=!1,e.runButton.disabled=!1}}async function Fe(e){const t=e.pathInput.value.trim();if(!t){h("masked-loss-audit-status","Pick a dataset folder first."),g("masked-loss-audit-results",'<p class="dataset-analysis-empty">No dataset folder selected yet.</p>');return}e.browseButton.disabled=!0,e.runButton.disabled=!0,h("masked-loss-audit-status","Inspecting alpha-channel masks..."),g("masked-loss-audit-results",'<p class="dataset-analysis-empty">Opening images and checking their alpha channels...</p>');try{const a=await jt({path:t,recursive:e.recursiveInput.checked,sample_limit:ae(e.sampleLimitInput.value,8)});if(a.status!=="success"||!a.data)throw new Error(a.message||"Masked-loss audit returned no data.");h("masked-loss-audit-status",`Inspected ${a.data.summary.image_count} images. Found ${a.data.summary.usable_mask_image_count} image(s) with usable alpha masks.`),aa(a.data)}catch(a){h("masked-loss-audit-status",a instanceof Error?a.message:"Masked-loss audit failed."),g("masked-loss-audit-results",`<article class="dataset-analysis-block dataset-analysis-warning"><p>${o(a instanceof Error?a.message:"Masked-loss audit failed.")}</p></article>`)}finally{e.browseButton.disabled=!1,e.runButton.disabled=!1}}async function je(e){var a,n,s;const t=e.pathInput.value.trim();if(!t){h("batch-tagger-status","Pick an image folder first."),g("batch-tagger-results",'<p class="dataset-analysis-empty">No image folder selected yet.</p>');return}e.browseButton.disabled=!0,e.runButton.disabled=!0,h("batch-tagger-status","Starting batch tagging..."),g("batch-tagger-results",'<p class="dataset-analysis-empty">Submitting interrogator job to the backend...</p>');try{const i=Oe(e.thresholdInput.value,.35,0,1),r=Oe(e.characterThresholdInput.value,.6,0,1),d=await Ht({path:t,interrogator_model:e.modelSelect.value,threshold:i,character_threshold:r,batch_output_action_on_conflict:e.conflictSelect.value,create_backup_before_write:e.autoBackupInput.checked,backup_snapshot_name:e.backupNameInput.value.trim(),additional_tags:e.additionalTagsInput.value.trim(),exclude_tags:e.excludeTagsInput.value.trim(),batch_input_recursive:e.recursiveInput.checked,replace_underscore:e.replaceUnderscoreInput.checked,escape_tag:e.escapeTagInput.checked,add_rating_tag:e.addRatingTagInput.checked,add_model_tag:e.addModelTagInput.checked});if(d.status!=="success")throw new Error(d.message||"Batch tagging failed to start.");h("batch-tagger-status",d.message||"Batch tagging started."),g("batch-tagger-results",`
        <article class="dataset-analysis-block">
          ...
          <p>
            ...
            ${(a=d.data)!=null&&a.backup?`· Snapshot: <code>${o(d.data.backup.archive_name)}</code>`:""}
          </p>
          ${(s=(n=d.data)==null?void 0:n.warnings)!=null&&s.length?`<p>${o(d.data.warnings.join(" "))}</p>`:""}
      ...
      `)}catch(i){h("batch-tagger-status",i instanceof Error?i.message:"Batch tagging failed."),g("batch-tagger-results",`<article class="dataset-analysis-block dataset-analysis-warning"><p>${o(i instanceof Error?i.message:"Batch tagging failed.")}</p></article>`)}finally{e.browseButton.disabled=!1,e.runButton.disabled=!1}}async function ce(e,t){const a=e.pathInput.value.trim();if(!a){h("caption-cleanup-status","Pick a caption folder first."),g("caption-cleanup-results",'<p class="dataset-analysis-empty">No caption folder selected yet.</p>');return}const n={path:a,caption_extension:e.extensionInput.value.trim()||".txt",recursive:e.recursiveInput.checked,collapse_whitespace:e.collapseWhitespaceInput.checked,replace_underscore:e.replaceUnderscoreInput.checked,dedupe_tags:e.dedupeTagsInput.checked,sort_tags:e.sortTagsInput.checked,remove_tags:e.removeTagsInput.value.trim(),prepend_tags:e.prependTagsInput.value.trim(),append_tags:e.appendTagsInput.value.trim(),search_text:e.searchTextInput.value,replace_text:e.replaceTextInput.value,use_regex:e.useRegexInput.checked,create_backup_before_apply:e.autoBackupInput.checked,backup_snapshot_name:e.backupNameInput.value.trim(),sample_limit:ae(e.sampleLimitInput.value,8)};e.browseButton.disabled=!0,e.previewButton.disabled=!0,e.applyButton.disabled=!0,h("caption-cleanup-status",t==="preview"?"Previewing caption cleanup...":"Applying caption cleanup..."),g("caption-cleanup-results",`<p class="dataset-analysis-empty">${t==="preview"?"Scanning caption files and building sample diffs...":"Writing cleaned captions back to disk..."}</p>`);try{const s=t==="preview"?await Mt(n):await zt(n);if(s.status!=="success"||!s.data)throw new Error(s.message||`Caption cleanup ${t} failed.`);h("caption-cleanup-status",s.message||(t==="preview"?`Previewed ${s.data.summary.changed_file_count} caption file changes.`:`Applied cleanup to ${s.data.summary.changed_file_count} caption files.`)),sa(s.data)}catch(s){h("caption-cleanup-status",s instanceof Error?s.message:"Caption cleanup failed."),g("caption-cleanup-results",`<article class="dataset-analysis-block dataset-analysis-warning"><p>${o(s instanceof Error?s.message:"Caption cleanup failed.")}</p></article>`)}finally{e.browseButton.disabled=!1,e.previewButton.disabled=!1,e.applyButton.disabled=!1}}async function G(e,t,a=!0){var s,i;const n=e.pathInput.value.trim();if(!n){h("caption-backup-status","Pick a caption folder first."),g("caption-backup-results",'<p class="dataset-analysis-empty">No caption folder selected yet.</p>'),e.selectInput.innerHTML='<option value="">Refresh snapshots for this folder</option>';return}e.browseButton.disabled=!0,e.createButton.disabled=!0,e.refreshButton.disabled=!0,e.restoreButton.disabled=!0,h("caption-backup-status","Loading caption snapshots...");try{const d=((s=(await Ut({path:n})).data)==null?void 0:s.backups)??[],u=e.selectInput.value||(((i=d[0])==null?void 0:i.archive_name)??""),l=t??u;e.selectInput.innerHTML=d.length?d.map(c=>{const p=c.archive_name===l?" selected":"";return`<option value="${o(c.archive_name)}"${p}>${o(c.snapshot_name)} · ${o(c.archive_name)}</option>`}).join(""):'<option value="">No snapshots for this folder yet</option>',d.length&&l&&(e.selectInput.value=l),h("caption-backup-status",d.length?`Loaded ${d.length} caption snapshots.`:"No caption snapshots found for this folder."),a&&na(d,d.length?l:null)}catch(r){h("caption-backup-status",r instanceof Error?r.message:"Failed to load caption snapshots."),g("caption-backup-results",`<article class="dataset-analysis-block dataset-analysis-warning"><p>${o(r instanceof Error?r.message:"Failed to load caption snapshots.")}</p></article>`)}finally{e.browseButton.disabled=!1,e.createButton.disabled=!1,e.refreshButton.disabled=!1,e.restoreButton.disabled=!1}}async function qa(e){const t=e.pathInput.value.trim();if(!t){h("caption-backup-status","Pick a caption folder first."),g("caption-backup-results",'<p class="dataset-analysis-empty">No caption folder selected yet.</p>');return}e.browseButton.disabled=!0,e.createButton.disabled=!0,e.refreshButton.disabled=!0,e.restoreButton.disabled=!0,h("caption-backup-status","Creating caption snapshot...");try{const a=await Xt({path:t,caption_extension:e.extensionInput.value.trim()||".txt",recursive:e.recursiveInput.checked,snapshot_name:e.nameInput.value.trim()});if(a.status!=="success"||!a.data)throw new Error(a.message||"Caption snapshot creation failed.");h("caption-backup-status",a.message||`Created ${a.data.archive_name}`),e.nameInput.value="",await G(e,a.data.archive_name)}catch(a){h("caption-backup-status",a instanceof Error?a.message:"Caption snapshot creation failed."),g("caption-backup-results",`<article class="dataset-analysis-block dataset-analysis-warning"><p>${o(a instanceof Error?a.message:"Caption snapshot creation failed.")}</p></article>`)}finally{e.browseButton.disabled=!1,e.createButton.disabled=!1,e.refreshButton.disabled=!1,e.restoreButton.disabled=!1}}async function Fa(e){const t=e.pathInput.value.trim(),a=e.selectInput.value;if(!t){h("caption-backup-status","Pick a caption folder first."),g("caption-backup-results",'<p class="dataset-analysis-empty">No caption folder selected yet.</p>');return}if(!a){h("caption-backup-status","Select a snapshot to restore.");return}if(window.confirm(`Restore caption snapshot ${a} into this folder?

This overwrites matching caption files from the snapshot.`)){e.browseButton.disabled=!0,e.createButton.disabled=!0,e.refreshButton.disabled=!0,e.restoreButton.disabled=!0,h("caption-backup-status","Restoring caption snapshot..."),g("caption-backup-results",'<p class="dataset-analysis-empty">Writing snapshot files back to the folder...</p>');try{const s=await Wt({path:t,archive_name:a,make_restore_backup:e.preRestoreInput.checked});if(s.status!=="success"||!s.data)throw new Error(s.message||"Caption snapshot restore failed.");h("caption-backup-status",s.message||`Restored ${s.data.restored_file_count} caption files.`),ia(s.data),await G(e,a,!1)}catch(s){h("caption-backup-status",s instanceof Error?s.message:"Caption snapshot restore failed."),g("caption-backup-results",`<article class="dataset-analysis-block dataset-analysis-warning"><p>${o(s instanceof Error?s.message:"Caption snapshot restore failed.")}</p></article>`)}finally{e.browseButton.disabled=!1,e.createButton.disabled=!1,e.refreshButton.disabled=!1,e.restoreButton.disabled=!1}}}function ae(e,t){const a=Number.parseInt(e,10);return Number.isNaN(a)||a<1?t:a}function Oe(e,t,a,n){const s=Number.parseFloat(e);return Number.isNaN(s)?t:Math.min(Math.max(s,a),n)}async function ge(){var e;try{const t=await we();Qt(((e=t.data)==null?void 0:e.tasks)??[]),document.querySelectorAll("[data-task-terminate]").forEach(a=>{a.addEventListener("click",async()=>{const n=a.dataset.taskTerminate;if(n){a.setAttribute("disabled","true");try{await it(n)}finally{await ge()}}})})}catch(t){g("task-table-container",`<p>${t instanceof Error?o(t.message):"Task request failed."}</p>`)}}async function ja(){const e=document.querySelector("#refresh-tasks");e==null||e.addEventListener("click",()=>{ge()}),await ge()}class x{constructor(t){$(this,"kind");$(this,"descriptionText");$(this,"defaultValue");$(this,"roleName");$(this,"roleConfig");$(this,"minValue");$(this,"maxValue");$(this,"stepValue");$(this,"disabledFlag",!1);$(this,"requiredFlag",!1);$(this,"literalValue");$(this,"options",[]);$(this,"fields",{});$(this,"itemType");this.kind=t}description(t){return this.descriptionText=t,this}default(t){return this.defaultValue=t,this}role(t,a){return this.roleName=typeof t=="string"?t:"custom",this.roleConfig=a??t,this}min(t){return this.minValue=t,this}max(t){return this.maxValue=t,this}step(t){return this.stepValue=t,this}required(){return this.requiredFlag=!0,this}disabled(){return this.disabledFlag=!0,this}}function M(e){if(e instanceof x)return e;if(e===String)return new x("string");if(e===Number)return new x("number");if(e===Boolean)return new x("boolean");if(typeof e=="string"||typeof e=="number"||typeof e=="boolean"){const t=new x("const");return t.literalValue=e,t.defaultValue=e,t}if(Array.isArray(e)){const t=new x("union");return t.options=e.map(a=>M(a)),t}if(e&&typeof e=="object"){const t=new x("object");return t.fields=Object.fromEntries(Object.entries(e).map(([a,n])=>[a,M(n)])),t}return new x("string")}function Oa(){return{string(){return new x("string")},number(){return new x("number")},boolean(){return new x("boolean")},const(e){const t=new x("const");return t.literalValue=e,t.defaultValue=e,t},union(e){const t=new x("union");return t.options=e.map(a=>M(a)),t},intersect(e){const t=new x("intersect");return t.options=e.map(a=>M(a)),t},object(e){const t=new x("object");return t.fields=Object.fromEntries(Object.entries(e).map(([a,n])=>[a,M(n)])),t},array(e){const t=new x("array");return t.itemType=M(e),t}}}function Ha(e,t,a){const n={...e,...t};for(const s of a??[])delete n[s];return n}function He(e,t){const a=Oa();return new Function("Schema","UpdateSchema","SHARED_SCHEMAS","String","Number","Boolean","source",'"use strict"; return eval(source);')(a,Ha,t??{},String,Number,Boolean,e)}function bt(e){const t=e.find(s=>s.name==="shared"),n=(t?He(t.schema,null):{})||{};return e.map(s=>({name:s.name,hash:s.hash,source:s.schema,runtime:s.name==="shared"?n:He(s.schema,n)}))}function Me(e,t=""){return Object.entries(e).map(([a,n])=>({name:a,path:t?`${t}.${a}`:a,schema:n})).filter(a=>a.schema.kind!=="const"||!a.schema.requiredFlag)}function ze(e){return Object.entries(e).filter(([,t])=>t.kind==="const"&&t.requiredFlag).map(([t,a])=>`${t} = ${String(a.literalValue)}`)}function Xe(e){return Object.fromEntries(Object.entries(e).filter(([,t])=>t.kind==="const"&&t.requiredFlag).map(([t,a])=>[t,a.literalValue]))}function fe(e,t,a){if(e.kind==="intersect"){e.options.forEach((n,s)=>fe(n,`${t}-i${s}`,a));return}if(e.kind==="object"){const n=Me(e.fields);n.length>0&&a.push({id:t,title:e.descriptionText||"Unnamed section",fields:n,conditions:ze(e.fields),constants:Xe(e.fields)});return}e.kind==="union"&&e.options.forEach((n,s)=>{if(n.kind==="object"){const i=Me(n.fields);i.length>0&&a.push({id:`${t}-u${s}`,title:n.descriptionText||e.descriptionText||`Conditional branch ${s+1}`,fields:i,conditional:!0,conditions:ze(n.fields),constants:Xe(n.fields)})}else fe(n,`${t}-u${s}`,a)})}function Ma(e){const t=[];return fe(e,"section",t),t}function za(e){const t={};for(const a of e){a.conditional||Object.assign(t,a.constants);for(const n of a.fields)n.schema.defaultValue!==void 0?t[n.path]=n.schema.defaultValue:n.schema.kind==="boolean"?t[n.path]=!1:t[n.path]=""}return t}function yt(e,t){return e.conditional?Object.entries(e.constants).every(([a,n])=>t[a]===n):!0}function Xa(e,t){const a={...t};for(const n of e){if(yt(n,t)){Object.assign(a,n.constants);continue}for(const s of n.fields)delete a[s.path]}return a}function Ae(e){return`field-${e.replaceAll(/[^a-zA-Z0-9_-]/g,"-")}`}function Ua(e){if(e.kind!=="union")return null;const t=e.options.filter(a=>a.kind==="const").map(a=>a.literalValue).filter(a=>typeof a=="string"||typeof a=="number"||typeof a=="boolean");return t.length!==e.options.length?null:t}function Wa(e,t){if(!e.roleConfig||typeof e.roleConfig!="object"||Array.isArray(e.roleConfig))return;const a=e.roleConfig[t];return typeof a=="string"?a:void 0}function be(e){return Array.isArray(e)?e.map(t=>String(t??"")):typeof e=="string"&&e.length>0?e.split(/\r?\n/):[]}function Va(e,t,a){const n=be(t),s=n.length>0?n:[""],i=Ae(e.path);return`
  ...
  `}function Ga(e,t){const a=e.schema,n=Ae(e.path),s=o(e.path),i=Ua(a),r=a.disabledFlag?"disabled":"",d=a.roleName||"";if(a.kind==="boolean")return`
    ...
    `;if(a.kind==="array"){if(d==="table")return Va(e,t,r);const u=Array.isArray(t)?t.join(`
`):"";return`<textarea id="${n}" class="field-input field-textarea" data-field-path="${s}" data-field-kind="array" ${r}>${o(u)}</textarea>`}if(i){const u=i.map(l=>`<option value="${o(l)}" ${String(l)===String(t)?"selected":""}>${o(l)}</option>`).join("");return`<select id="${n}" class="field-input" data-field-path="${s}" data-field-kind="enum" ${r}>${u}</select>`}if(a.kind==="number"){const u=a.minValue!==void 0?`min="${a.minValue}"`:"",l=a.maxValue!==void 0?`max="${a.maxValue}"`:"",c=a.stepValue!==void 0?`step="${a.stepValue}"`:'step="any"';if(d==="slider"&&a.minValue!==void 0&&a.maxValue!==void 0){const p=t===""||t===void 0||t===null?a.defaultValue??a.minValue:t;return`
      ...
      `}return`<input id="${n}" class="field-input" data-field-path="${s}" data-field-kind="number" type="number" value="${o(t)}" ${u} ${l} ${c} ${r} />`}if(d==="textarea")return`<textarea id="${n}" class="field-input field-textarea" data-field-path="${s}" data-field-kind="string" ${r}>${o(t)}</textarea>`;if(d==="filepicker"){const u=Wa(a,"type")??(e.path.endsWith("_dir")||e.path==="resume"?"folder":"model-file");return`
  ...
  `}function vt(e){return e.sections.filter(t=>yt(t,e.values))}function kt(e){return Xa(e.sections,e.values)}function Ja(e,t){const a=vt(e);if(a.length===0){g(t,"<p>No renderable sections extracted from this schema.</p>");return}const n=a.map(s=>{const i=s.fields.map(d=>Ka(d,e.values[d.path])).join(""),r=s.conditions.length?`<div class="condition-list">${s.conditions.map(d=>`<span class="coverage-pill coverage-pill-muted">${o(d)}</span>`).join("")}</div>`:"";return`
      ...
      `}).join("");g(t,n)}function ye(e,t){const a=Object.fromEntries(Object.entries(kt(e)).sort(([n],[s])=>n.localeCompare(s)));X(t,JSON.stringify(a,null,2))}function oe(e){return e.filter(t=>t.name!=="shared"&&t.runtime instanceof x)}function Ue(e,t){const a=e.schema;if(a.kind==="boolean")return!!t;if(a.kind==="number"){const n=String(t).trim();if(n==="")return"";const s=Number(n);return Number.isNaN(s)?"":s}return a.kind==="array"?String(t).split(/\r?\n/).map(n=>n.trim()).filter(Boolean):t}function We(e,t){return e.sections.flatMap(a=>a.fields).find(a=>a.path===t)}function Ya(e,t){return[...e.querySelectorAll('[data-field-kind="table-row"]')].filter(a=>a.dataset.fieldPath===t).map(a=>a.value.trim()).filter(Boolean)}function Ve(e,t,a,n){const s=String(a??"");e.querySelectorAll("[data-field-path]").forEach(i=>{if(!(i===n||i.dataset.fieldPath!==t||i.dataset.fieldKind==="table-row")){if(i instanceof HTMLInputElement&&i.type==="checkbox"){i.checked=!!a;return}i.value=s}}),e.querySelectorAll("[data-slider-value-for]").forEach(i=>{i.dataset.sliderValueFor===t&&(i.textContent=s)})}function de(e,t,a,n="idle"){e.querySelectorAll("[data-picker-status-for]").forEach(s=>{s.dataset.pickerStatusFor===t&&(s.textContent=a,s.classList.remove("is-success","is-error"),n==="success"?s.classList.add("is-success"):n==="error"&&s.classList.add("is-error"))})}function Za(e,t,a,n){const s=document.querySelector(`#${t.sectionsId}`);if(!s)return;const i=new Set(e.sections.flatMap(r=>r.conditional?Object.keys(r.constants):[]));s.querySelectorAll("[data-field-path]").forEach(r=>{const d=r.dataset.fieldKind,u=r instanceof HTMLInputElement&&r.type==="checkbox"||r instanceof HTMLSelectElement?"change":"input";r.addEventListener(u,()=>{const l=r.dataset.fieldPath;if(!l)return;const c=We(e,l);if(c){if(d==="table-row")e.values[l]=Ya(s,l);else{const p=r instanceof HTMLInputElement&&r.type==="checkbox"?r.checked:r.value;e.values[l]=Ue(c,p),Ve(s,l,e.values[l],r)}if(i.has(l)){n({...e,values:{...e.values}});return}ye(e,t.previewId),a(e)}})}),s.querySelectorAll("[data-table-add]").forEach(r=>{r.addEventListener("click",()=>{const d=r.dataset.tableAdd;d&&(e.values[d]=[...be(e.values[d]),""],n({...e,values:{...e.values}}))})}),s.querySelectorAll("[data-table-remove]").forEach(r=>{r.addEventListener("click",()=>{const d=r.dataset.tableRemove,u=Number(r.dataset.tableIndex??"-1");if(!d||u<0)return;const l=be(e.values[d]).filter((c,p)=>p!==u);e.values[d]=l,n({...e,values:{...e.values}})})}),s.querySelectorAll("[data-picker-path]").forEach(r=>{r.addEventListener("click",async()=>{const d=r.dataset.pickerPath,u=r.dataset.pickerType||"model-file";if(!d)return;const l=We(e,d);if(l){r.setAttribute("disabled","true"),de(s,d,"Waiting for native picker...","idle");try{const c=await O(u);if(e.values[d]=Ue(l,c),Ve(s,d,e.values[d]),de(s,d,c,"success"),i.has(d)){n({...e,values:{...e.values}});return}ye(e,t.previewId),a(e)}catch(c){de(s,d,c instanceof Error?c.message:"The picker failed to return a value.","error")}finally{r.removeAttribute("disabled")}}})})}function se(e,t){const a=oe(e).find(s=>s.name===t);if(!a||!(a.runtime instanceof x))return null;const n=Ma(a.runtime);return{catalog:e,selectedName:t,sections:n,values:za(n)}}function K(e,t,a,n){if(a(e),!e){h(t.summaryId,"Failed to build schema bridge state."),g(t.sectionsId,"<p>Schema bridge failed to initialize.</p>"),X(t.previewId,"{}");return}const i=oe(e.catalog).map(l=>`<option value="${o(l.name)}" ${l.name===e.selectedName?"selected":""}>${o(l.name)}</option>`).join(""),r=vt(e);g(t.selectId,i),h(t.summaryId,`${e.selectedName} · ${r.length}/${e.sections.length} visible sections · ${r.reduce((l,c)=>l+c.fields.length,0)} visible fields`),Ja(e,t.sectionsId),ye(e,t.previewId);const d=document.querySelector(`#${t.selectId}`);d&&(d.onchange=()=>{const l=se(e.catalog,d.value);K(l,t,a,n)});const u=document.querySelector(`#${t.resetId}`);u&&(u.onclick=()=>{K(se(e.catalog,e.selectedName),t,a,n)}),Za(e,t,n,l=>K(l,t,a,n)),n(e)}const Qa={selectId:"schema-select",summaryId:"schema-summary",sectionsId:"schema-sections",previewId:"schema-preview",resetId:"schema-reset"};function es(e){return{selectId:`${e}-schema-select`,summaryId:`${e}-summary`,sectionsId:`${e}-sections`,previewId:`${e}-preview`,resetId:`${e}-reset`}}async function ts(e){var t,a,n;try{const i=((t=(await xe()).data)==null?void 0:t.schemas)??[],r=bt(i),d=oe(r),u=((a=d.find(l=>l.name==="sdxl-lora"))==null?void 0:a.name)??((n=d[0])==null?void 0:n.name);if(!u){h("schema-summary","No selectable schemas were returned."),g("schema-sections","<p>No schema runtime available.</p>");return}K(se(r,u),Qa,e,()=>{})}catch(s){h("schema-summary","Schema bridge request failed"),g("schema-sections",`<p>${s instanceof Error?o(s.message):"Unknown error"}</p>`),X("schema-preview","{}")}}function as(e,t){return`
    <div class="app-shell">
  ...
  `}function Ge(e,t,a="module"){return`
  ...
  `}function ss(){return`
    ...
    <section class="two-column">
      ${Ge("Project identity",`
        ...
        `,"brand")}
      ${Ge("Why migrate this page first",`
  ...
  `}function ns(){return w({prefix:"anima-finetune",heroKicker:"anima finetune",heroTitle:"Anima finetune source training page",heroLede:"This route exposes the Anima finetune schema so the source-side bridge covers both LoRA and full finetune variants for that trainer family.",runnerTitle:"Anima finetune source-side runner",startButtonLabel:"Start Anima finetune",legacyPath:"/lora/anima-finetune.html",legacyLabel:"Open current shipped Anima finetune page",renderedTitle:"Anima finetune form bridge"})}function is(){return w({prefix:"anima",heroKicker:"anima lora",heroTitle:"Anima LoRA source training page",heroLede:"This route surfaces the Anima LoRA schema on the shared training bridge instead of forcing that capability to stay hidden behind the shipped legacy page.",runnerTitle:"Anima LoRA source-side runner",startButtonLabel:"Start Anima LoRA training",legacyPath:"/lora/anima.html",legacyLabel:"Open current shipped Anima LoRA page",renderedTitle:"Anima LoRA form bridge"})}function rs(){return w({prefix:"dreambooth",heroKicker:"dreambooth train",heroTitle:"Dreambooth source training page",heroLede:"This route brings the Dreambooth and SDXL full-finetune schema into the same source-side training bridge so we can migrate one of the last big non-LoRA training paths cleanly.",runnerTitle:"Dreambooth source-side runner",startButtonLabel:"Start Dreambooth training",legacyPath:"/dreambooth/",legacyLabel:"Open current shipped Dreambooth page",renderedTitle:"Dreambooth form bridge"})}function os(){return w({prefix:"flux-controlnet",heroKicker:"flux controlnet",heroTitle:"Flux ControlNet source training page",heroLede:"This route reuses the same source-side training bridge for Flux ControlNet so the DiT-family conditioning workflow stays aligned with the current backend schema and payload rules.",runnerTitle:"Flux ControlNet source-side runner",startButtonLabel:"Start Flux ControlNet training",legacyPath:"/lora/flux-controlnet.html",legacyLabel:"Open current shipped Flux ControlNet page",renderedTitle:"Flux ControlNet form bridge"})}function ls(){return w({prefix:"flux-finetune",heroKicker:"flux finetune",heroTitle:"Flux finetune source training page",heroLede:"This route exposes the dedicated Flux full-finetune schema on the same source-side training bridge so recipe shaping, preflight and launch behavior stay consistent.",runnerTitle:"Flux finetune source-side runner",startButtonLabel:"Start Flux finetune",legacyPath:"/lora/flux-finetune.html",legacyLabel:"Open current shipped Flux finetune page",renderedTitle:"Flux finetune form bridge"})}function cs(){return w({prefix:"flux",heroKicker:"flux train",heroTitle:"Flux LoRA source training page",heroLede:"This route reuses the source-side training bridge for Flux so we can keep payload shaping, compatibility checks and launch behavior aligned with the current backend.",runnerTitle:"Flux source-side runner",startButtonLabel:"Start Flux training",legacyPath:"/lora/flux.html",legacyLabel:"Open current shipped Flux page",renderedTitle:"Flux form bridge"})}function ds(){return w({prefix:"hunyuan-image",heroKicker:"hunyuan image",heroTitle:"Hunyuan Image LoRA source training page",heroLede:"This route exposes the Hunyuan Image LoRA schema so newer image trainer families live on the same source-side bridge instead of staying legacy-only.",runnerTitle:"Hunyuan Image source-side runner",startButtonLabel:"Start Hunyuan Image training",legacyPath:"/lora/hunyuan.html",legacyLabel:"Open current shipped Hunyuan Image page",renderedTitle:"Hunyuan Image form bridge"})}function ps(){return w({prefix:"lumina-finetune",heroKicker:"lumina finetune",heroTitle:"Lumina finetune source training page",heroLede:"This route exposes Lumina finetune on the shared source-side bridge so finetune-specific payloads can use the same autosave, preflight and launch safety checks.",runnerTitle:"Lumina finetune source-side runner",startButtonLabel:"Start Lumina finetune",legacyPath:"/lora/lumina-finetune.html",legacyLabel:"Open current shipped Lumina finetune page",renderedTitle:"Lumina finetune form bridge"})}function us(){return w({prefix:"lumina",heroKicker:"lumina lora",heroTitle:"Lumina LoRA source training page",heroLede:"This route exposes the Lumina LoRA schema on the shared bridge so newer trainer families are available without falling back to older UI entry points.",runnerTitle:"Lumina LoRA source-side runner",startButtonLabel:"Start Lumina LoRA training",legacyPath:"/lora/lumina.html",legacyLabel:"Open current shipped Lumina LoRA page",renderedTitle:"Lumina LoRA form bridge"})}function hs(){return`
  ...
  `}function Is(){return w({prefix:"xti",heroKicker:"sd xti",heroTitle:"SD XTI source training page",heroLede:"This route exposes the SD XTI schema on the shared source-side bridge so more specialized embedding workflows are no longer hidden behind the legacy page only.",runnerTitle:"SD XTI source-side runner",startButtonLabel:"Start SD XTI training",legacyPath:"/lora/xti.html",legacyLabel:"Open current shipped SD XTI page",renderedTitle:"SD XTI form bridge"})}function As(e,t){if(t.length===0){g(e,"<p>No GPUs reported. Training will use the backend default environment.</p>");return}const a=t.map((n,s)=>{const i=n.index??n.id??s,r=String(i);return`
        <label class="gpu-chip">
          <input type="checkbox" data-gpu-id="${o(r)}" />
          <span>GPU ${o(r)}: ${o(n.name)}</span>
        </label>
      `}).join("");g(e,`<div class="gpu-chip-grid">${a}</div>`)}function Ee(e){return[...document.querySelectorAll(`#${e} input[data-gpu-id]:checked`)].map(t=>t.dataset.gpuId).filter(t=>!!t)}function Pe(e,t=[]){const a=new Set(t.map(n=>String(n)));document.querySelectorAll(`#${e}-gpu-selector input[data-gpu-id]`).forEach(n=>{const s=n.dataset.gpuId??"";n.checked=a.has(s)})}function Es(e){switch(e){case"prompt_file":return"Prompt file";case"generated":return"Generated from current fields";case"random_dataset_prompt_preview":return"Random dataset-derived prompt";case"legacy_sample_prompts_file":return"Legacy sample_prompts file";case"legacy_sample_prompts_inline":return"Legacy sample_prompts text";default:return e}}function L(e,t,a,n="idle"){g(`${e}-submit-status`,`
      <div class="submit-status-box submit-status-${n}">
        <strong>${o(t)}</strong>
        <p>${o(a)}</p>
      </div>
    `)}function ne(e,t,a){if(a){g(`${e}-validation-status`,`
    ...
    `)}function Ps(e){const t=[];let a="",n=null,s=0;for(let i=0;i<e.length;i+=1){const r=e[i],d=i>0?e[i-1]:"";if(n){a+=r,r===n&&d!=="\\"&&(n=null);continue}if(r==='"'||r==="'"){n=r,a+=r;continue}if(r==="["){s+=1,a+=r;continue}if(r==="]"){s-=1,a+=r;continue}if(r===","&&s===0){t.push(a.trim()),a="";continue}a+=r}return a.trim().length>0&&t.push(a.trim()),t}function Ns(e){let t=null,a=!1,n="";for(const s of e){if(t){if(n+=s,t==='"'&&s==="\\"&&!a){a=!0;continue}s===t&&!a&&(t=null),a=!1;continue}if(s==='"'||s==="'"){t=s,n+=s;continue}if(s==="#")break;n+=s}return n.trim()}function xt(e){return e.startsWith('"')&&e.endsWith('"')?e.slice(1,-1).replaceAll('\\"','"').replaceAll("\\n",`
`).replaceAll("\\t","	").replaceAll("\\\\","\\"):e.startsWith("'")&&e.endsWith("'")?e.slice(1,-1):e}function wt(e){const t=e.trim();return t.length===0?"":t.startsWith('"')&&t.endsWith('"')||t.startsWith("'")&&t.endsWith("'")?xt(t):t==="true"?!0:t==="false"?!1:t.startsWith("[")&&t.endsWith("]")?Ps(t.slice(1,-1)).map(a=>wt(a)):/^[+-]?\d[\d_]*(\.\d[\d_]*)?([eE][+-]?\d+)?$/.test(t)?Number(t.replaceAll("_","")):t}function Je(e){return e.split(".").map(t=>t.trim()).filter(Boolean).map(t=>xt(t))}function Rs(e,t,a){let n=e;for(let s=0;s<t.length-1;s+=1){const i=t[s],r=n[i];(!r||typeof r!="object"||Array.isArray(r))&&(n[i]={}),n=n[i]}n[t[t.length-1]]=a}function Ne(e){const t={};let a=[];for(const n of e.split(/\r?\n/)){const s=Ns(n);if(!s)continue;if(s.startsWith("[[")&&s.endsWith("]]"))throw new Error("Array-of-table syntax is not supported in custom params yet.");if(s.startsWith("[")&&s.endsWith("]")){a=Je(s.slice(1,-1));continue}const i=s.indexOf("=");if(i===-1)throw new Error(`Invalid TOML line: ${n}`);const r=Je(s.slice(0,i));if(r.length===0)throw new Error(`Invalid TOML key: ${n}`);Rs(t,[...a,...r],wt(s.slice(i+1)))}return t}function pe(e){return JSON.stringify(e)}function $t(e){return typeof e=="string"?pe(e):typeof e=="number"?Number.isFinite(e)?String(e):pe(String(e)):typeof e=="boolean"?e?"true":"false":Array.isArray(e)?`[${e.map(t=>$t(t)).join(", ")}]`:pe(JSON.stringify(e))}function St(e,t=[],a=[]){const n=[];for(const[s,i]of Object.entries(e)){if(i&&typeof i=="object"&&!Array.isArray(i)){St(i,[...t,s],a);continue}n.push([s,i])}return a.push({path:t,values:n}),a}function ve(e){const t=St(e).filter(n=>n.values.length>0).sort((n,s)=>n.path.join(".").localeCompare(s.path.join("."))),a=[];for(const n of t){n.path.length>0&&(a.length>0&&a.push(""),a.push(`[${n.path.join(".")}]`));for(const[s,i]of n.values.sort(([r],[d])=>r.localeCompare(d)))a.push(`${s} = ${$t(i)}`)}return a.join(`
`)}const Cs=["pretrained_model_name_or_path","train_data_dir","reg_data_dir","output_dir","network_weights","conditioning_data_dir","controlnet_model_name_or_path","weights","vae","text_encoder","byt5","qwen3","llm_adapter_path","t5_tokenizer_path","ae","clip_l","clip_g","t5xxl","gemma2"],Ds=["learning_rate","unet_lr","text_encoder_lr","learning_rate_te","learning_rate_te1","learning_rate_te2","learning_rate_te3","sigmoid_scale","guidance_scale","training_shift","control_net_lr","self_attn_lr","cross_attn_lr","mlp_lr","mod_lr","llm_adapter_lr"],Bs=["lycoris_algo","conv_dim","conv_alpha","dropout","dylora_unit","lokr_factor","train_norm","down_lr_weight","mid_lr_weight","up_lr_weight","block_lr_zero_threshold","enable_block_weights","enable_preview","network_args_custom","optimizer_args_custom","enable_base_weight","prodigy_d0","prodigy_d_coef","ui_custom_params"],qs=["vae","reg_data_dir","network_weights","conditioning_data_dir","controlnet_model_name_or_path","weights","init_word","text_encoder","byt5","qwen3","llm_adapter_path","t5_tokenizer_path","ae","clip_l","clip_g","t5xxl","gemma2","noise_offset","multires_noise_iterations","multires_noise_discount","caption_dropout_rate","network_dropout","scale_weight_norms","gpu_ids"],Ye=["v2","v_parameterization","scale_v_pred_loss_like_noise_pred","clip_skip","learning_rate_te","stop_text_encoder_training"],Fs=["learning_rate_te1","learning_rate_te2"],js=[["cache_text_encoder_outputs","shuffle_caption"],["noise_offset","multires_noise_iterations"],["cache_latents","color_aug"],["cache_latents","random_crop"]],Ze={algo:"lycoris_algo",unit:"dylora_unit",factor:"lokr_factor"},Os=new Set(["conv_dim","conv_alpha","dropout","down_lr_weight","mid_lr_weight","up_lr_weight","block_lr_zero_threshold"]),Hs=new Set(["decouple","weight_decay","use_bias_correction","safeguard_warmup"]),Ms=new Set(["base_weights","base_weights_multiplier"]),zs={pretrained_model_name_or_path:"./sd-models/model.safetensors",train_data_dir:"./train/aki",resolution:"512,512",enable_bucket:!0,min_bucket_reso:256,max_bucket_reso:1024,output_name:"aki",output_dir:"./output",save_model_as:"safetensors",save_every_n_epochs:2,max_train_epochs:10,train_batch_size:1,network_train_unet_only:!1,network_train_text_encoder_only:!1,learning_rate:1e-4,unet_lr:1e-4,text_encoder_lr:1e-5,lr_scheduler:"cosine_with_restarts",optimizer_type:"AdamW8bit",lr_scheduler_num_cycles:1,network_module:"networks.lora",network_dim:32,network_alpha:32,logging_dir:"./logs",caption_extension:".txt",shuffle_caption:!0,keep_tokens:0,max_token_length:255,seed:1337,prior_loss_weight:1,clip_skip:2,mixed_precision:"fp16",save_precision:"fp16",xformers:!0,cache_latents:!0,persistent_data_loader_workers:!0};function ke(e){return JSON.parse(JSON.stringify(e??{}))}function Z(e){return Array.isArray(e)?e.map(t=>String(t??"").trim()).filter(Boolean):String(e??"").split(/\r?\n/).map(t=>t.trim()).filter(Boolean)}function q(e,t){return Object.prototype.hasOwnProperty.call(e,t)}function Xs(e){return String(e.model_train_type??"").startsWith("sdxl")}function Us(e){return String(e.model_train_type??"")==="sd3-finetune"}function v(e){return e==null?"":String(e)}function Ws(e){return v(e).replaceAll("\\","/")}function ie(e,t=0){const a=Number.parseFloat(v(e));return Number.isNaN(a)?t:a}function y(e){return!!e}function Qe(e){const t=e.indexOf("=");return t===-1?{key:e.trim(),value:"",hasValue:!1}:{key:e.slice(0,t).trim(),value:e.slice(t+1).trim(),hasValue:!0}}function Vs(e){if(typeof e=="boolean")return e;const t=v(e).toLowerCase();return t==="true"||t==="1"||t==="yes"}function Re(e,t=String(e.model_train_type??"")){const a=t==="lora-basic"?{...zs,...ke(e)}:ke(e),n=[],s=[],i=Xs(a),r=Us(a);(i||r)&&[a.learning_rate_te1,a.learning_rate_te2,a.learning_rate_te3].some(y)&&(a.train_text_encoder=!0);const d=i?Ye.filter(c=>c!=="clip_skip"):r?Ye:Fs;for(const c of d)q(a,c)&&delete a[c];a.network_module==="lycoris.kohya"?(n.push(`conv_dim=${v(a.conv_dim)}`,`conv_alpha=${v(a.conv_alpha)}`,`dropout=${v(a.dropout)}`,`algo=${v(a.lycoris_algo)}`),y(a.lokr_factor)&&n.push(`factor=${v(a.lokr_factor)}`),y(a.train_norm)&&n.push("train_norm=True")):a.network_module==="networks.dylora"&&n.push(`unit=${v(a.dylora_unit)}`);const u=v(a.optimizer_type),l=u.toLowerCase();l.startsWith("dada")?((u==="DAdaptation"||u==="DAdaptAdam")&&s.push("decouple=True","weight_decay=0.01"),a.learning_rate=1,a.unet_lr=1,a.text_encoder_lr=1):l==="prodigy"&&(s.push("decouple=True","weight_decay=0.01","use_bias_correction=True",`d_coef=${v(a.prodigy_d_coef)}`),y(a.lr_warmup_steps)&&s.push("safeguard_warmup=True"),y(a.prodigy_d0)&&s.push(`d0=${v(a.prodigy_d0)}`)),y(a.enable_block_weights)&&(n.push(`down_lr_weight=${v(a.down_lr_weight)}`,`mid_lr_weight=${v(a.mid_lr_weight)}`,`up_lr_weight=${v(a.up_lr_weight)}`,`block_lr_zero_threshold=${v(a.block_lr_zero_threshold)}`),delete a.block_lr_zero_threshold),y(a.enable_base_weight)?(a.base_weights=Z(a.base_weights),a.base_weights_multiplier=Z(a.base_weights_multiplier).map(c=>ie(c))):(delete a.base_weights,delete a.base_weights_multiplier);for(const c of Z(a.network_args_custom))n.push(c);for(const c of Z(a.optimizer_args_custom))s.push(c);y(a.enable_preview)||(delete a.sample_prompts,delete a.sample_sampler,delete a.sample_every_n_epochs);for(const c of Ds)q(a,c)&&(a[c]=ie(a[c]));for(const c of qs){if(!q(a,c))continue;const p=a[c];(p===0||p===""||Array.isArray(p)&&p.length===0)&&delete a[c]}for(const c of Cs)q(a,c)&&a[c]&&(a[c]=Ws(a[c]));if(n.length>0?a.network_args=n:delete a.network_args,s.length>0?a.optimizer_args=s:delete a.optimizer_args,y(a.ui_custom_params)){const c=Ne(v(a.ui_custom_params));Object.assign(a,c)}for(const c of Bs)q(a,c)&&delete a[c];return Array.isArray(a.gpu_ids)&&(a.gpu_ids=a.gpu_ids.map(c=>{const p=v(c),m=p.match(/GPU\s+(\d+):/);return m?m[1]:p})),a}function Gs(e){const t=[],a=[],n=v(e.optimizer_type),s=n.toLowerCase(),i=v(e.model_train_type),r=i.startsWith("sdxl"),d=i==="sd3-finetune",u=i==="anima-lora"||i==="anima-finetune";n.startsWith("DAdapt")&&e.lr_scheduler!=="constant"&&t.push("DAdaptation works best with lr_scheduler set to constant."),s.startsWith("prodigy")&&(q(e,"unet_lr")||q(e,"text_encoder_lr"))&&(ie(e.unet_lr,1)!==1||ie(e.text_encoder_lr,1)!==1)&&t.push("Prodigy usually expects unet_lr and text_encoder_lr to stay at 1."),e.network_module==="networks.oft"&&i!=="sdxl-lora"&&a.push("OFT is currently only supported for SDXL LoRA."),d&&y(e.train_text_encoder)&&y(e.cache_text_encoder_outputs)&&!y(e.use_t5xxl_cache_only)&&a.push("SD3 full finetune cannot train text encoders while cache_text_encoder_outputs is enabled."),d&&y(e.train_t5xxl)&&!y(e.train_text_encoder)&&a.push("train_t5xxl requires train_text_encoder to be enabled first."),d&&y(e.train_t5xxl)&&y(e.cache_text_encoder_outputs)&&a.push("train_t5xxl cannot be combined with cache_text_encoder_outputs."),u&&y(e.unsloth_offload_checkpointing)&&y(e.cpu_offload_checkpointing)&&a.push("unsloth_offload_checkpointing cannot be combined with cpu_offload_checkpointing."),u&&y(e.unsloth_offload_checkpointing)&&y(e.blocks_to_swap)&&a.push("unsloth_offload_checkpointing cannot be combined with blocks_to_swap."),y(e.masked_loss)&&!y(e.alpha_mask)&&!y(e.conditioning_data_dir)&&t.push("masked_loss is on, but alpha_mask is off. For normal alpha-channel datasets this often becomes a no-op."),r&&y(e.clip_skip)&&t.push("SDXL clip_skip in this build is experimental. Use the same clip-skip behavior at inference time if you rely on it.");for(const[l,c]of js)y(e[l])&&y(e[c])&&a.push(`Parameters ${l} and ${c} conflict. Please enable only one of them.`);return{warnings:t,errors:a}}function Tt(e){const t=ke(e);if(Array.isArray(t.network_args)){const a=[];for(const n of t.network_args){const{key:s,value:i,hasValue:r}=Qe(v(n));if(s==="train_norm"){t.train_norm=r?Vs(i):!0;continue}if((s==="down_lr_weight"||s==="mid_lr_weight"||s==="up_lr_weight"||s==="block_lr_zero_threshold")&&(t.enable_block_weights=!0),Os.has(s)){t[s]=i;continue}if(Ze[s]){t[Ze[s]]=i;continue}a.push(v(n))}a.length>0&&(t.network_args_custom=a),delete t.network_args}if(Array.isArray(t.optimizer_args)){const a=[];for(const n of t.optimizer_args){const{key:s,value:i}=Qe(v(n));if(s==="d_coef"){t.prodigy_d_coef=i;continue}if(s==="d0"){t.prodigy_d0=i;continue}Hs.has(s)||a.push(v(n))}a.length>0&&(t.optimizer_args_custom=a),delete t.optimizer_args}for(const a of Ms)Array.isArray(t[a])&&(t[a]=t[a].map(n=>v(n)).join(`
`),a==="base_weights"&&(t.enable_base_weight=!0),a==="base_weights_multiplier"&&(t.enable_base_weight=!0));return Array.isArray(t.gpu_ids)&&(t.gpu_ids=t.gpu_ids.map(a=>v(a))),t}function U(e,t){return`
    <div class="training-library-meta">
      <span class="coverage-pill coverage-pill-muted">${o(e)}</span>
    </div>
    <p class="training-library-note">${o(t)}</p>
  `}function J(e,t){const a=t.values.output_name;return typeof a=="string"&&a.trim().length>0?a.trim():`${e.modelLabel} snapshot`}function Ks(e){try{return JSON.stringify(Re(H(e.value)),null,2)}catch(t){return t instanceof Error?t.message:"Unable to preview this snapshot."}}function Js(e,t){if(t.length===0){g(`${e}-history-panel`,`
        <div class="training-side-panel-head">
          <div>
        ...
        ${U("0 snapshots","Saved parameter snapshots stay in this browser and can restore form values plus selected GPUs.")}
      ...
      `);return}const a=t.map((n,s)=>`
        <article class="history-card">
          ...
          <pre class="history-preview">${o(Ks(n))}</pre>
      ...
      ${U(`${t.length} snapshot${t.length===1?"":"s"}`,"Saved parameter snapshots stay in this browser and can restore form values plus selected GPUs.")}
      <div class="history-list">${a}</div>
    `)}function Ys(e,t){if(t.length===0){g(`${e}-presets-panel`,`
        <div class="training-side-panel-head">
          <div>
        ...
        ${U("0 presets","Backend presets are shared read-only templates. Save recipe copies one into your local browser library.")}
      ...
      ${U(`${t.length} preset${t.length===1?"":"s"}`,"Backend presets are shared read-only templates. Save recipe copies one into your local browser library.")}
      <div class="preset-list">${a}</div>
    `)}function Zs(e,t){if(t.length===0){g(`${e}-recipes-panel`,`
        <div class="training-side-panel-head">
          <div>
        ...
        ${U("0 recipes","Recipes are editable local copies stored per route in this browser. Import merges JSON or TOML here, and Export writes preset TOML files.")}
      ...
      `);return}const a=t.map((n,s)=>`
        <article class="preset-card">
          ...
          <pre class="preset-preview">${o(JSON.stringify(Re(H(n.value)),null,2))}</pre>
          <div class="preset-card-actions">
      ...
      ${U(`${t.length} recipe${t.length===1?"":"s"}`,"Recipes are editable local copies stored per route in this browser. Import merges JSON or TOML here, and Export writes preset TOML files.")}
      <div class="preset-list">${a}</div>
    `)}function Qs(e,t){const a=new Set(e.presetTrainTypes);return t.filter(n=>{const i=(n.metadata??{}).train_type;return typeof i!="string"||i.trim().length===0?!0:a.has(i)})}function S(e,t,a){const n=document.querySelector(`#${e}-history-panel`),s=document.querySelector(`#${e}-recipes-panel`),i=document.querySelector(`#${e}-presets-panel`);n&&(n.hidden=t==="history"?!a:!0),s&&(s.hidden=t==="recipes"?!a:!0),i&&(i.hidden=t==="presets"?!a:!0)}async function et(e,t){try{const a=await Gt(t);if(a.status!=="success")throw new Error(a.message||"Training preflight failed.");return Ke(e.prefix,a.data??null),a.data??null}catch(a){throw Ke(e.prefix,null,a instanceof Error?a.message:"Training preflight failed."),a}}function en(e){var t;(t=document.querySelector(`#${e.prefix}-stop-train`))==null||t.addEventListener("click",async()=>{var a;try{const s=(((a=(await we()).data)==null?void 0:a.tasks)??[]).find(r=>String(r.status).toUpperCase()==="RUNNING");if(!s){b(e.prefix,"No running training task was found.","warning");return}const i=String(s.id??s.task_id??"");if(!i){b(e.prefix,"The running task does not expose an id.","error");return}if(!window.confirm(`Stop running task ${i}?`))return;await it(i),L(e.prefix,"Training stop requested",`Sent terminate request for task ${i}.`,"warning"),b(e.prefix,`Terminate requested for task ${i}.`,"warning")}catch(n){b(e.prefix,n instanceof Error?n.message:"Failed to stop training.","error")}})}function tn(e,t,a){var s;(s=document.querySelector(`#${e.prefix}-run-preflight`))==null||s.addEventListener("click",async()=>{const i=t();if(!i){L(e.prefix,"Editor not ready",`The ${e.modelLabel} schema editor state is not initialized yet.`,"error");return}try{const r=a(i);ne(e.prefix,r.checks),await et(e,r.payload),b(e.prefix,"Training preflight completed.","success")}catch(r){b(e.prefix,r instanceof Error?r.message:"Training preflight failed.","error")}});const n=document.querySelector(`#${e.prefix}-start-train`);n==null||n.addEventListener("click",async()=>{var r;const i=t();if(!i){L(e.prefix,"Editor not ready",`The ${e.modelLabel} schema editor state is not initialized yet.`,"error");return}n.setAttribute("disabled","true"),L(e.prefix,"Submitting training job...","Sending the current payload to /api/run.","idle");try{const d=a(i);if(d.checks.errors.length>0){L(e.prefix,"Fix parameter conflicts first",d.checks.errors.join(" "),"error"),ne(e.prefix,d.checks);return}const u=await et(e,d.payload);if(u&&!u.can_start){L(e.prefix,"Resolve preflight errors first",u.errors.join(" "),"error");return}const l=await Vt(d.payload);if(l.status==="success"){const p=[...d.checks.warnings,...(u==null?void 0:u.warnings)??[],...((r=l.data)==null?void 0:r.warnings)??[]].join(" ");L(e.prefix,"Training request accepted",`${l.message||"Training started."}${p?` ${p}`:""}`,p?"warning":"success")}else L(e.prefix,"Training request failed",l.message||"Unknown backend failure.","error")}catch(d){L(e.prefix,"Training request failed",d instanceof Error?d.message:"Unknown network error.","error")}finally{n.removeAttribute("disabled")}})}function an(e){return e.trim().replace(/[^0-9A-Za-z._-]+/g,"-").replace(/-+/g,"-").replace(/^[-_.]+|[-_.]+$/g,"")||"training-preset"}function sn(e,t,a){const n=J(e,t),s=String(a.payload.model_train_type??"");return{metadata:{name:n,version:"1.0",author:"SD-reScripts local export",train_type:s||e.schemaName,description:`Exported from the ${e.modelLabel} source-side training bridge on ${new Date().toLocaleString()}.`},data:a.payload}}function nn(e,t,a,n){const s=J(e,t),i=window.prompt("Recipe name",s);if(!i||!i.trim())return!1;const r=window.prompt("Recipe description (optional)","")??"",d=E(e.routeId);return d.unshift({created_at:new Date().toLocaleString(),name:i.trim(),description:r.trim()||void 0,train_type:String(a.payload.model_train_type??e.schemaName),route_id:e.routeId,value:H(a.payload)}),V(e.routeId,Ie(d)),n(),!0}function tt(e,t,a){const n=t.data&&typeof t.data=="object"&&!Array.isArray(t.data)?t.data:t.value&&typeof t.value=="object"&&!Array.isArray(t.value)?t.value:t;if(!n||typeof n!="object"||Array.isArray(n)||Object.keys(n).length===0)return null;const s=t.metadata&&typeof t.metadata=="object"&&!Array.isArray(t.metadata)?t.metadata:{},i=String(s.name||t.name||a||"Imported recipe").trim();return{created_at:String(t.created_at||new Date().toLocaleString()),name:i||"Imported recipe",description:typeof s.description=="string"?s.description:typeof t.description=="string"?t.description:void 0,train_type:typeof s.train_type=="string"?s.train_type:typeof t.train_type=="string"?t.train_type:typeof n.model_train_type=="string"?n.model_train_type:e.schemaName,route_id:typeof t.route_id=="string"?t.route_id:e.routeId,value:H(n)}}function rn(e,t,a){const n=a.trim();if(!n)throw new Error("Recipe file is empty.");const s=t.toLowerCase().endsWith(".json")?JSON.parse(n):Ne(n),i=[];if(Array.isArray(s))s.forEach((r,d)=>{if(!r||typeof r!="object"||Array.isArray(r))return;const u=tt(e,r,`Imported recipe ${d+1}`);u&&i.push(u)});else if(s&&typeof s=="object"){const r=tt(e,s,t.replace(/\.[^.]+$/,""));r&&i.push(r)}if(i.length===0)throw new Error("No valid recipe entries were found in this file.");return i}function on(e,t,a){var s;const n=B(e.routeId);n.unshift({time:new Date().toLocaleString(),name:J(e,t),value:H(t.values),gpu_ids:Ee(`${e.prefix}-gpu-selector`)}),te(e.routeId,ft(n)),(s=document.querySelector(`#${e.prefix}-history-panel`))!=null&&s.hidden||a()}function ln(e,t,a,n){var s,i,r,d;(s=document.querySelector(`#${e.prefix}-download-config`))==null||s.addEventListener("click",()=>{const u=t();if(!u)return;const l=a(u);z(`${e.prefix}-${he()}.toml`,ve(l.payload)),b(e.prefix,"Exported current config as TOML.","success")}),(i=document.querySelector(`#${e.prefix}-export-preset`))==null||i.addEventListener("click",()=>{const u=t();if(!u)return;const l=a(u),c=sn(e,u,l),p=an(J(e,u)||e.prefix);z(`${p}-preset.toml`,ve(c)),b(e.prefix,"Exported current config as reusable preset TOML.","success")}),(r=document.querySelector(`#${e.prefix}-import-config`))==null||r.addEventListener("click",()=>{var u;(u=document.querySelector(`#${e.prefix}-config-file-input`))==null||u.click()}),(d=document.querySelector(`#${e.prefix}-config-file-input`))==null||d.addEventListener("change",u=>{var m;const l=u.currentTarget,c=(m=l.files)==null?void 0:m[0];if(!c)return;const p=new FileReader;p.onload=()=>{try{const f=Ne(String(p.result??"")),k=f.data&&typeof f.data=="object"&&!Array.isArray(f.data)?f.data:f;n(k),b(e.prefix,f.data&&typeof f.data=="object"?`Imported preset: ${c.name}.`:`Imported config: ${c.name}.`,"success")}catch(f){b(e.prefix,f instanceof Error?f.message:"Failed to import config.","error")}finally{l.value=""}},p.readAsText(c)})}function cn(e,t){var a;(a=document.querySelector(`#${e.prefix}-history-file-input`))==null||a.addEventListener("change",n=>{var d;const s=n.currentTarget,i=(d=s.files)==null?void 0:d[0];if(!i)return;const r=new FileReader;r.onload=()=>{try{const u=JSON.parse(String(r.result??""));if(!Array.isArray(u))throw new Error("History file must contain an array.");const l=u.filter(p=>p&&typeof p=="object"&&p.value&&typeof p.value=="object").map(p=>({time:String(p.time||new Date().toLocaleString()),name:p.name?String(p.name):void 0,value:H(p.value),gpu_ids:Array.isArray(p.gpu_ids)?p.gpu_ids.map(m=>String(m)):[]}));if(l.length===0)throw new Error("History file did not contain valid entries.");const c=ft([...B(e.routeId),...l]);te(e.routeId,c),t(),b(e.prefix,`Imported ${l.length} history entries.`,"success")}catch(u){b(e.prefix,u instanceof Error?u.message:"Failed to import history.","error")}finally{s.value=""}},r.readAsText(i)})}function dn(e,t,a){var n;(n=document.querySelector(`#${e.prefix}-recipe-file-input`))==null||n.addEventListener("change",s=>{var u;const i=s.currentTarget,r=(u=i.files)==null?void 0:u[0];if(!r)return;const d=new FileReader;d.onload=()=>{try{const l=rn(e,r.name,String(d.result??"")),c=Ie([...l,...E(e.routeId)]);V(e.routeId,c),t(),a(),b(e.prefix,`Imported ${l.length} recipe ${l.length===1?"entry":"entries"}.`,"success")}catch(l){b(e.prefix,l instanceof Error?l.message:"Failed to import recipe.","error")}finally{i.value=""}},d.readAsText(r)})}function pn(e,t,a){g(`${e}-sample-prompt-workspace`,`
      <div class="submit-status-box">
        <strong>${o(t)}</strong>
        <p>${o(a)}</p>
      </div>
    `)}function un(e){switch(e){case"prompt_file":return"Prompt file";case"generated":return"Generated from current fields";case"random_dataset_prompt_preview":return"Random dataset-derived prompt";case"legacy_sample_prompts_file":return"Legacy sample_prompts file";case"legacy_sample_prompts_inline":return"Legacy sample_prompts text";default:return e}}function re(e){pn(e,"Sample prompt workspace is waiting for refresh","Edit prompt fields freely, then click Refresh prompt to inspect the exact text that would be used.")}function Q(e,t,a){if(a){g(`${e}-sample-prompt-workspace`,`
        <div class="submit-status-box submit-status-error">
          <strong>Sample prompt preview failed</strong>
          <p>${o(a)}</p>
        </div>
      `);return}if(!t){re(e);return}const n=[t.warnings.length?`
          <div>
            <strong>Warnings</strong>
            <ul class="status-list">
      ...
      <div class="submit-status-box ${s}">
        ...
        <p class="training-preflight-meta">${o(un(t.source))}${t.detail?` · ${o(t.detail)}`:""}</p>
        <p class="training-preflight-meta">${o(i)} Download will use ${o(t.suggested_file_name)}.</p>
        ${n}
        <pre class="preset-preview">${o(t.preview)}</pre>
      </div>
    `)}async function at(e,t,a){const n=t();if(!n)throw new Error(`${e.modelLabel} editor is not ready yet.`);const s=a(n),i=await Kt(s.payload);if(i.status!=="success"||!i.data)throw new Error(i.message||"Sample prompt preview failed.");return i.data}function hn(e){var i,r,d,u;const{config:t,getCurrentState:a,buildPreparedTrainingPayload:n,applyEditableRecord:s}=e;(i=document.querySelector(`#${t.prefix}-refresh-sample-prompt`))==null||i.addEventListener("click",async()=>{try{const l=await at(t,a,n);Q(t.prefix,l),b(t.prefix,"Sample prompt preview refreshed.","success")}catch(l){Q(t.prefix,null,l instanceof Error?l.message:"Sample prompt preview failed."),b(t.prefix,l instanceof Error?l.message:"Sample prompt preview failed.","error")}}),(r=document.querySelector(`#${t.prefix}-download-sample-prompt`))==null||r.addEventListener("click",async()=>{try{const l=await at(t,a,n);Q(t.prefix,l),z(l.suggested_file_name||"sample-prompts.txt",l.content||""),b(t.prefix,`Sample prompt exported as ${l.suggested_file_name}.`,"success")}catch(l){Q(t.prefix,null,l instanceof Error?l.message:"Sample prompt export failed."),b(t.prefix,l instanceof Error?l.message:"Sample prompt export failed.","error")}}),(d=document.querySelector(`#${t.prefix}-pick-prompt-file`))==null||d.addEventListener("click",async()=>{try{const l=await O("text-file");s({prompt_file:l},void 0,"merge"),re(t.prefix),b(t.prefix,"Prompt file path inserted into the current form state.","success")}catch(l){b(t.prefix,l instanceof Error?l.message:"Prompt file picker failed.","error")}}),(u=document.querySelector(`#${t.prefix}-clear-prompt-file`))==null||u.addEventListener("click",()=>{s({prompt_file:""},void 0,"merge"),re(t.prefix),b(t.prefix,"prompt_file cleared from the current form state.","warning")})}function mn(e){var f,k,_,A,D,W,Ce;const{config:t,createDefaultState:a,getCurrentState:n,mountTrainingState:s,onStateChange:i,applyEditableRecord:r,buildPreparedTrainingPayload:d,bindHistoryPanel:u,bindRecipePanel:l,openHistoryPanel:c,openRecipePanel:p,openPresetPanel:m}=e;document.querySelectorAll(`#${t.prefix}-gpu-selector input[data-gpu-id]`).forEach(T=>{T.addEventListener("change",()=>{const Y=n();Y&&i(Y)})}),(f=document.querySelector(`#${t.prefix}-reset-all`))==null||f.addEventListener("click",()=>{const T=a();Pe(t.prefix,[]),s(T),b(t.prefix,"Reset to schema defaults.","warning")}),(k=document.querySelector(`#${t.prefix}-save-params`))==null||k.addEventListener("click",()=>{const T=n();T&&(on(t,T,u),b(t.prefix,"Current parameters saved to history.","success"))}),(_=document.querySelector(`#${t.prefix}-read-params`))==null||_.addEventListener("click",()=>{c()}),(A=document.querySelector(`#${t.prefix}-save-recipe`))==null||A.addEventListener("click",()=>{const T=n();if(!T)return;const Y=d(T);nn(t,T,Y,l)&&b(t.prefix,"Current config saved to the local recipe library.","success")}),(D=document.querySelector(`#${t.prefix}-read-recipes`))==null||D.addEventListener("click",()=>{p()}),(W=document.querySelector(`#${t.prefix}-import-recipe`))==null||W.addEventListener("click",()=>{var T;(T=document.querySelector(`#${t.prefix}-recipe-file-input`))==null||T.click()}),(Ce=document.querySelector(`#${t.prefix}-load-presets`))==null||Ce.addEventListener("click",()=>{m()}),ln(t,n,d,r),cn(t,c),dn(t,l,p),hn({config:t,getCurrentState:n,buildPreparedTrainingPayload:d,applyEditableRecord:r}),en(t),tn(t,n,d)}function gn(e,t){let a=null;const n=()=>{const l=B(e.routeId);Js(e.prefix,l),document.querySelectorAll(`#${e.prefix}-history-panel [data-history-close]`).forEach(c=>{c.addEventListener("click",()=>S(e.prefix,"history",!1))}),document.querySelectorAll(`#${e.prefix}-history-panel [data-history-export]`).forEach(c=>{c.addEventListener("click",()=>{z(`${e.prefix}-history-${he()}.json`,JSON.stringify(B(e.routeId),null,2),"application/json;charset=utf-8"),b(e.prefix,"History exported.","success")})}),document.querySelectorAll(`#${e.prefix}-history-panel [data-history-import]`).forEach(c=>{c.addEventListener("click",()=>{var p;(p=document.querySelector(`#${e.prefix}-history-file-input`))==null||p.click()})}),document.querySelectorAll(`#${e.prefix}-history-panel [data-history-apply]`).forEach(c=>{c.addEventListener("click",()=>{const p=Number(c.dataset.historyApply??"-1"),m=B(e.routeId)[p];m&&(t(m.value,m.gpu_ids,"replace"),S(e.prefix,"history",!1),b(e.prefix,`Applied snapshot: ${m.name||"Unnamed snapshot"}.`,"success"))})}),document.querySelectorAll(`#${e.prefix}-history-panel [data-history-rename]`).forEach(c=>{c.addEventListener("click",()=>{const p=Number(c.dataset.historyRename??"-1"),m=B(e.routeId),f=m[p];if(!f)return;const k=window.prompt("Rename snapshot",f.name||"");k&&(f.name=k.trim(),te(e.routeId,m),n(),b(e.prefix,"Snapshot renamed.","success"))})}),document.querySelectorAll(`#${e.prefix}-history-panel [data-history-delete]`).forEach(c=>{c.addEventListener("click",()=>{const p=Number(c.dataset.historyDelete??"-1"),m=B(e.routeId),f=m[p];f&&window.confirm(`Delete snapshot "${f.name||"Unnamed snapshot"}"?`)&&(m.splice(p,1),te(e.routeId,m),n(),b(e.prefix,"Snapshot deleted.","success"))})})},s=()=>{n(),S(e.prefix,"history",!0)},i=()=>{const l=E(e.routeId);Zs(e.prefix,l),document.querySelectorAll(`#${e.prefix}-recipes-panel [data-recipe-close]`).forEach(c=>{c.addEventListener("click",()=>S(e.prefix,"recipes",!1))}),document.querySelectorAll(`#${e.prefix}-recipes-panel [data-recipe-export-all]`).forEach(c=>{c.addEventListener("click",()=>{z(`${e.prefix}-recipes-${he()}.json`,JSON.stringify(E(e.routeId),null,2),"application/json;charset=utf-8"),b(e.prefix,"Recipe library exported.","success")})}),document.querySelectorAll(`#${e.prefix}-recipes-panel [data-recipe-import]`).forEach(c=>{c.addEventListener("click",()=>{var p;(p=document.querySelector(`#${e.prefix}-recipe-file-input`))==null||p.click()})}),document.querySelectorAll(`#${e.prefix}-recipes-panel [data-recipe-merge]`).forEach(c=>{c.addEventListener("click",()=>{const p=Number(c.dataset.recipeMerge??"-1"),m=E(e.routeId)[p];m&&(t(m.value,void 0,"merge"),S(e.prefix,"recipes",!1),b(e.prefix,`Merged recipe: ${m.name}.`,"success"))})}),document.querySelectorAll(`#${e.prefix}-recipes-panel [data-recipe-replace]`).forEach(c=>{c.addEventListener("click",()=>{const p=Number(c.dataset.recipeReplace??"-1"),m=E(e.routeId)[p];m&&(t(m.value,void 0,"replace"),S(e.prefix,"recipes",!1),b(e.prefix,`Replaced current values with recipe: ${m.name}.`,"success"))})}),document.querySelectorAll(`#${e.prefix}-recipes-panel [data-recipe-export]`).forEach(c=>{c.addEventListener("click",()=>{const p=Number(c.dataset.recipeExport??"-1"),m=E(e.routeId)[p];m&&(z(`${m.name.replace(/[^0-9A-Za-z._-]+/g,"-")||"recipe"}-preset.toml`,ve({metadata:{name:m.name,version:"1.0",author:"SD-reScripts local recipe",train_type:m.train_type||e.schemaName,description:m.description||`Exported recipe from ${e.modelLabel}.`},data:m.value})),b(e.prefix,`Exported recipe: ${m.name}.`,"success"))})}),document.querySelectorAll(`#${e.prefix}-recipes-panel [data-recipe-rename]`).forEach(c=>{c.addEventListener("click",()=>{const p=Number(c.dataset.recipeRename??"-1"),m=E(e.routeId),f=m[p];if(!f)return;const k=window.prompt("Rename recipe",f.name);!k||!k.trim()||(f.name=k.trim(),V(e.routeId,m),i(),b(e.prefix,"Recipe renamed.","success"))})}),document.querySelectorAll(`#${e.prefix}-recipes-panel [data-recipe-delete]`).forEach(c=>{c.addEventListener("click",()=>{const p=Number(c.dataset.recipeDelete??"-1"),m=E(e.routeId),f=m[p];f&&window.confirm(`Delete recipe "${f.name}"?`)&&(m.splice(p,1),V(e.routeId,m),i(),b(e.prefix,"Recipe deleted.","success"))})})},r=()=>{i(),S(e.prefix,"recipes",!0)},d=()=>{Ys(e.prefix,a??[]),document.querySelectorAll(`#${e.prefix}-presets-panel [data-preset-close]`).forEach(l=>{l.addEventListener("click",()=>S(e.prefix,"presets",!1))}),document.querySelectorAll(`#${e.prefix}-presets-panel [data-preset-merge]`).forEach(l=>{l.addEventListener("click",()=>{const c=Number(l.dataset.presetMerge??"-1"),p=a==null?void 0:a[c];if(!p)return;const m=p.data??{};t(m,void 0,"merge"),S(e.prefix,"presets",!1),b(e.prefix,`Merged preset: ${String((p.metadata??{}).name||p.name||"preset")}.`,"success")})}),document.querySelectorAll(`#${e.prefix}-presets-panel [data-preset-save-recipe]`).forEach(l=>{l.addEventListener("click",()=>{var _;const c=Number(l.dataset.presetSaveRecipe??"-1"),p=a==null?void 0:a[c];if(!p)return;const m=p.metadata??{},f=p.data??{},k=E(e.routeId);k.unshift({created_at:new Date().toLocaleString(),name:String(m.name||p.name||"Imported preset recipe"),description:typeof m.description=="string"?m.description:void 0,train_type:typeof m.train_type=="string"?m.train_type:e.schemaName,route_id:e.routeId,value:JSON.parse(JSON.stringify(f))}),V(e.routeId,Ie(k)),(_=document.querySelector(`#${e.prefix}-recipes-panel`))!=null&&_.hidden||i(),b(e.prefix,`Saved preset to local recipe library: ${String(m.name||p.name||"preset")}.`,"success")})}),document.querySelectorAll(`#${e.prefix}-presets-panel [data-preset-replace]`).forEach(l=>{l.addEventListener("click",()=>{const c=Number(l.dataset.presetReplace??"-1"),p=a==null?void 0:a[c];if(!p)return;const m=p.data??{};t(m,void 0,"replace"),S(e.prefix,"presets",!1),b(e.prefix,`Replaced current values with preset: ${String((p.metadata??{}).name||p.name||"preset")}.`,"success")})})};return{bindHistoryPanel:n,bindRecipePanel:i,openHistoryPanel:s,openRecipePanel:r,openPresetPanel:async()=>{var l;if(!a)try{const c=await nt();a=Qs(e,((l=c.data)==null?void 0:l.presets)??[])}catch(c){b(e.prefix,c instanceof Error?c.message:"Failed to load presets.","error");return}d(),S(e.prefix,"presets",!0)}}}async function fn(e){var d,u,l,c;const t=es(e.prefix),[a,n]=await Promise.allSettled([xe(),rt()]);if(n.status==="fulfilled"){const p=((d=n.value.data)==null?void 0:d.cards)??[],m=(u=n.value.data)==null?void 0:u.xformers;As(`${e.prefix}-gpu-selector`,p),h(`${e.prefix}-runtime-title`,`${p.length} GPU entries reachable`),g(`${e.prefix}-runtime-body`,`
        <p>${o(dt(p))}</p>
        <p>${o(m?`xformers: ${m.installed?"installed":"missing"}, ${m.supported?"supported":"fallback"} (${m.reason})`:"xformers info unavailable")}</p>
      `)}else h(`${e.prefix}-runtime-title`,"GPU runtime request failed"),h(`${e.prefix}-runtime-body`,n.reason instanceof Error?n.reason.message:"Unknown error");if(a.status!=="fulfilled")return h(t.summaryId,`${e.modelLabel} schema request failed`),g(t.sectionsId,`<p>${a.reason instanceof Error?o(a.reason.message):"Unknown error"}</p>`),X(t.previewId,"{}"),L(e.prefix,"Schema unavailable",`The ${e.modelLabel} training bridge could not load the backend schema.`,"error"),null;const s=((l=a.value.data)==null?void 0:l.schemas)??[],i=bt(s),r=(c=oe(i).find(p=>p.name===e.schemaName))==null?void 0:c.name;return r?{domIds:t,createDefaultState:()=>se(i,r)}:(h(t.summaryId,`No ${e.schemaName} schema was returned.`),g(t.sectionsId,`<p>The backend did not expose ${o(e.schemaName)}.</p>`),L(e.prefix,"Schema missing",`The backend did not expose the ${e.schemaName} schema.`,"error"),null)}const st={};function bn(e,t){const a=kt(t),n=Ee(`${e}-gpu-selector`);n.length>0&&(a.gpu_ids=n);const s=Re(a);return{payload:s,checks:Gs(s)}}function Lt(e){return new Set(e.sections.flatMap(t=>t.fields.map(a=>a.path)))}function It(e,t){const a=Lt(e),n={...e.values};for(const[s,i]of Object.entries(t))a.has(s)&&(n[s]=i);return{...e,values:n}}function yn(e,t){return{...e,values:{...e.values,...Object.fromEntries(Object.entries(t).filter(([a])=>Lt(e).has(a)))}}}function vn(e,t){return t&&t.length>0?t.map(a=>String(a)):Array.isArray(e.gpu_ids)?e.gpu_ids.map(a=>String(a)):[]}function kn(e,t){ya(e.routeId,{time:new Date().toLocaleString(),name:J(e,t),value:H(t.values),gpu_ids:Ee(`${e.prefix}-gpu-selector`)})}function _n(e){const{config:t,createDefaultState:a,mountTrainingState:n}=e,s=ba(t.routeId),i=s!=null&&s.value?It(a(),Tt(s.value)):a();(s==null?void 0:s.gpu_ids)!==void 0&&Pe(t.prefix,s.gpu_ids),n(i),s!=null&&s.value&&b(t.prefix,"Restored autosaved parameters for this route.","success")}function xn(e,t,a,n,s){return i=>{try{const r=a(i),d=Object.fromEntries(Object.entries(r.payload).sort(([u],[l])=>u.localeCompare(l)));X(t.previewId,JSON.stringify(d,null,2)),ne(e.prefix,r.checks)}catch(r){X(t.previewId,"{}"),ne(e.prefix,{warnings:[],errors:[]},r instanceof Error?r.message:"The current state could not be converted into a launch payload.")}n(i),s==null||s()}}function wn(e,t,a){const n=()=>st[e.routeId],s=l=>bn(e.prefix,l),i=xn(e,t,s,l=>kn(e,l),()=>re(e.prefix)),r=l=>{K(l,t,c=>{st[e.routeId]=c},i)};return{getCurrentState:n,prepareTrainingPayload:s,onStateChange:i,mountTrainingState:r,applyEditableRecord:(l,c,p="replace")=>{const m=p==="merge"?n()??a():a(),f=Tt(l),k=p==="merge"?yn(m,f):It(m,f);Pe(e.prefix,vn(f,c)),r(k)},restoreAutosave:()=>_n({config:e,createDefaultState:a,mountTrainingState:r})}}async function $n(e){const t=await fn(e);if(!t)return;const a=wn(e,t.domIds,t.createDefaultState),n=gn(e,a.applyEditableRecord);a.restoreAutosave(),mn({config:e,createDefaultState:t.createDefaultState,getCurrentState:a.getCurrentState,mountTrainingState:a.mountTrainingState,onStateChange:a.onStateChange,applyEditableRecord:a.applyEditableRecord,buildPreparedTrainingPayload:a.prepareTrainingPayload,bindHistoryPanel:n.bindHistoryPanel,bindRecipePanel:n.bindRecipePanel,openHistoryPanel:n.openHistoryPanel,openRecipePanel:n.openRecipePanel,openPresetPanel:n.openPresetPanel}),L(e.prefix,`${e.modelLabel} bridge ready`,"You can review the generated payload and submit the current config to /api/run.","success"),S(e.prefix,"history",!1),S(e.prefix,"recipes",!1),S(e.prefix,"presets",!1)}const Sn={overview:_t,about:ss,settings:xs,tasks:$s,tageditor:ws,tensorboard:Ss,tools:Ts,"schema-bridge":hs,"sdxl-train":_s,"flux-train":cs,"sd3-train":gs,"sd3-finetune-train":ms,"dreambooth-train":rs,"flux-finetune-train":ls,"sd-controlnet-train":fs,"sdxl-controlnet-train":ys,"flux-controlnet-train":os,"sdxl-lllite-train":vs,"sd-ti-train":bs,"xti-train":Is,"sdxl-ti-train":ks,"anima-train":is,"anima-finetune-train":ns,"lumina-train":us,"lumina-finetune-train":ps,"hunyuan-image-train":ds};function Tn(e){const t={overview:j.filter(a=>a.section==="overview"),phase1:j.filter(a=>a.section==="phase1"),reference:j.filter(a=>a.section==="reference")};return`
    <div class="nav-group">
  ...
  `}async function Ln(e){e==="overview"?await va():e==="settings"?await xa():e==="tasks"?await ja():e==="tageditor"?await Sa():e==="tools"?await Ta():e==="schema-bridge"?await ts(()=>{}):me[e]&&await $n(me[e])}async function In(e){ma();const t=ha(),a=Sn[t.id]??_t;e.innerHTML=as(t.hash,a());const n=document.querySelector("#side-nav");n&&(n.innerHTML=Tn(t.hash)),await Ln(t.id)}const At=document.querySelector("#app");if(!(At instanceof HTMLElement))throw new Error("App root not found.");const An=At;async function Et(){await In(An)}window.addEventListener("hashchange",()=>{Et()});Et();
