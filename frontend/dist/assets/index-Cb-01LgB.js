var Bt=Object.defineProperty;var qt=(e,t,a)=>t in e?Bt(e,t,{enumerable:!0,configurable:!0,writable:!0,value:a}):e[t]=a;var x=(e,t,a)=>qt(e,typeof t!="symbol"?t+"":t,a);(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))n(s);new MutationObserver(s=>{for(const i of s)if(i.type==="childList")for(const r of i.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&n(r)}).observe(document,{childList:!0,subtree:!0});function a(s){const i={};return s.integrity&&(i.integrity=s.integrity),s.referrerPolicy&&(i.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?i.credentials="include":s.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function n(s){if(s.ep)return;s.ep=!0;const i=a(s);fetch(s.href,i)}})();const Se="".replace(/\/$/,"");async function P(e){const t=await fetch(`${Se}${e}`,{headers:{Accept:"application/json"}});if(!t.ok)throw new Error(`${t.status} ${t.statusText}`);return await t.json()}async function N(e,t){const a=await fetch(`${Se}${e}`,{method:"POST",headers:{Accept:"application/json","Content-Type":"application/json"},body:JSON.stringify(t)});if(!a.ok)throw new Error(`${a.status} ${a.statusText}`);return await a.json()}async function Ft(e){const t=await fetch(`${Se}${e}`,{headers:{Accept:"application/json"}});if(!t.ok)throw new Error(`${t.status} ${t.statusText}`);return await t.json()}async function jt(){return P("/api/schemas/hashes")}async function Te(){return P("/api/schemas/all")}async function pt(){return P("/api/presets")}async function Ot(){return P("/api/config/saved_params")}async function Ht(){return P("/api/config/summary")}async function Le(){return P("/api/tasks")}async function dt(e){return P(`/api/tasks/terminate/${e}`)}async function ut(){return P("/api/graphic_cards")}async function ht(){return Ft("/api/tageditor_status")}async function Mt(){return P("/api/scripts")}async function zt(e){return N("/api/dataset/analyze",e)}async function Ut(e){return N("/api/dataset/masked_loss_audit",e)}async function Xt(){return P("/api/interrogators")}async function O(e){var a;const t=await P(`/api/pick_file?picker_type=${encodeURIComponent(e)}`);if(t.status!=="success"||!((a=t.data)!=null&&a.path))throw new Error(t.message||"File picker did not return a path.");return t.data.path}async function Wt(e){return N("/api/interrogate",e)}async function Vt(e){return N("/api/captions/cleanup/preview",e)}async function Gt(e){return N("/api/captions/cleanup/apply",e)}async function Kt(e){return N("/api/captions/backups/create",e)}async function Jt(e){return N("/api/captions/backups/list",e)}async function Yt(e){return N("/api/captions/backups/restore",e)}async function Zt(e){return N("/api/run",e)}async function Qt(e){return N("/api/train/preflight",e)}async function ea(e){return N("/api/train/sample_prompt",e)}function h(e,t){const a=document.querySelector(`#${e}`);a&&(a.textContent=t)}function f(e,t){const a=document.querySelector(`#${e}`);a&&(a.innerHTML=t)}function U(e,t){const a=document.querySelector(`#${e}`);a&&(a.textContent=t)}const mt=[{route:"index.html",title:"SD-reScripts | SD training UI",section:"core",status:"migrate-first",notes:"Landing page and main navigation entry. Good first candidate for source migration."},{route:"lora/index.html",title:"LoRA training index",section:"training",status:"migrate-first",notes:"Top-level training model selector page.",schemaHints:["shared"]},{route:"lora/sdxl.html",title:"SDXL LoRA training",section:"training",status:"migrate-first",notes:"Primary training page currently used most often.",schemaHints:["sdxl-lora","shared"]},{route:"lora/flux.html",title:"Flux LoRA training",section:"training",status:"migrate-first",notes:"Now mirrored by the shared source-side training bridge.",schemaHints:["flux-lora","shared"]},{route:"lora/sd3.html",title:"SD3 training",section:"training",status:"migrate-first",notes:"Now mirrored by the shared source-side training bridge.",schemaHints:["sd3-lora","shared"]},{route:"lora/controlnet.html",title:"SD ControlNet training",section:"training",status:"migrate-first",notes:"Now mirrored by the shared source-side training bridge.",schemaHints:["sd-controlnet","shared"]},{route:"lora/sdxl-controlnet.html",title:"SDXL ControlNet training",section:"training",status:"migrate-first",notes:"Now mirrored by the shared source-side training bridge.",schemaHints:["sdxl-controlnet","shared"]},{route:"lora/sdxl-lllite.html",title:"SDXL LLLite training",section:"training",status:"migrate-first",notes:"Specialized SDXL conditioning route now mirrored by the shared source-side bridge.",schemaHints:["sdxl-controlnet-lllite","shared"]},{route:"lora/flux-controlnet.html",title:"Flux ControlNet training",section:"training",status:"migrate-first",notes:"Now mirrored by the shared source-side training bridge.",schemaHints:["flux-controlnet","shared"]},{route:"lora/basic.html",title:"LoRA basic mode",section:"training",status:"legacy-dist",notes:"Legacy beginner-mode training route.",schemaHints:["lora-basic","shared"]},{route:"lora/master.html",title:"LoRA expert mode",section:"training",status:"legacy-dist",notes:"Legacy expert-mode training route.",schemaHints:["lora-master","shared"]},{route:"lora/params.html",title:"Training parameter reference",section:"training",status:"migrate-first",notes:"Mostly explanatory UI. Lower risk to recreate cleanly."},{route:"lora/tools.html",title:"LoRA tools",section:"tools",status:"migrate-first",notes:"Tool launcher route for merge, resize, interrogate and conversion flows."},{route:"dreambooth/index.html",title:"Dreambooth training",section:"training",status:"migrate-first",notes:"Now mirrored by the shared source-side training bridge for Dreambooth and SDXL full finetune.",schemaHints:["dreambooth","shared"]},{route:"tagger.html",title:"Tagger tool",section:"tools",status:"migrate-first",notes:"Standalone caption/tag generation route that talks to backend APIs.",schemaHints:["tagger"]},{route:"tageditor.html",title:"Tag editor proxy page",section:"tools",status:"migrate-first",notes:"Wrapper page with progress/failure states. Good candidate to reimplement cleanly."},{route:"task.html",title:"Task monitor",section:"system",status:"migrate-first",notes:"Task status page backed by /api/tasks."},{route:"tensorboard.html",title:"TensorBoard proxy page",section:"system",status:"migrate-first",notes:"Wrapper/proxy page. Safer than schema-heavy form routes."},{route:"other/settings.html",title:"Settings page",section:"system",status:"migrate-first",notes:"Static/system page that should be easy to recreate in source form."},{route:"other/about.html",title:"About page",section:"core",status:"migrate-first",notes:"Mostly branding and release notes. Best low-risk migration target."},{route:"404.html",title:"Fallback page",section:"core",status:"legacy-dist",notes:"Can be replaced after the main router is rebuilt."}];function o(e){return String(e).replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}function H(e){return JSON.parse(JSON.stringify(e))}function ge(e=new Date){return e.toISOString().replaceAll(":","-").replaceAll(".","-")}function ta(e){if(e.length===0){f("schema-browser","<p>No schemas returned.</p>");return}const t=e.map(a=>{var s;const n=((s=a.schema.split(/\r?\n/).find(i=>i.trim().length>0))==null?void 0:s.trim())||"No preview available.";return`
      ...
      `}).join("");f("schema-browser",t)}function aa(e){const t=new Set(mt.flatMap(i=>i.schemaHints??[])),a=new Set(e.map(i=>i.name)),n=[...t].filter(i=>a.has(i)).sort(),s=e.map(i=>i.name).filter(i=>!t.has(i)).sort();f("schema-mapped",n.length?n.map(i=>`<span class="coverage-pill">${o(i)}</span>`).join(""):"<p>No mapped schema hints yet.</p>"),f("schema-unmapped",s.length?s.map(i=>`<span class="coverage-pill coverage-pill-muted">${o(i)}</span>`).join(""):"<p>All schemas are represented in the current route hints.</p>")}function sa(e){if(!e.length){f("training-catalog","<p>No training routes were registered.</p>");return}const t=e.length,a=e.filter(l=>l.schemaAvailable).length,n=e.filter(l=>l.presetCount>0).length,s=e.filter(l=>l.localRecipeCount>0).length,i=new Map,r=new Map;for(const l of e){i.set(l.family,(i.get(l.family)??0)+1);for(const p of l.capabilities)r.set(p,(r.get(p)??0)+1)}const c=`
    ...
    <div class="coverage-list training-catalog-capabilities">
      ${[...r.entries()].sort((l,p)=>p[1]-l[1]||l[0].localeCompare(p[0])).map(([l,p])=>`<span class="coverage-pill">${o(l)} <strong>${p}</strong></span>`).join("")}
    </div>
  `,u=e.map(l=>`
        <article class="training-catalog-card" data-family="${o(l.family)}">
          ...
          <div class="coverage-list training-catalog-capability-row">
            ${l.capabilities.map(p=>`<span class="coverage-pill coverage-pill-muted">${o(p)}</span>`).join("")}
          </div>
        </article>
      `).join("");f("training-catalog",`
      ${c}
      <div class="training-catalog-grid">${u}</div>
    `)}function na(e){if(e.length===0){f("task-table-container","<p>No tasks currently tracked.</p>");return}const t=e.map(a=>`
        <tr>
    ...
    `)}function ia(e){if(e.length===0){f("tools-browser","<p>No scripts returned.</p>");return}const t=e.map(a=>`
    ...
    `)}function oa(e,t="masked-loss-audit-results"){const a=[{label:"Images",value:e.summary.image_count},{label:"Alpha channel images",value:e.summary.alpha_channel_image_count},{label:"Usable masks",value:e.summary.usable_mask_image_count},{label:"Soft alpha masks",value:e.summary.soft_alpha_image_count},{label:"Binary alpha masks",value:e.summary.binary_alpha_image_count},{label:"Avg masked area",value:ee(e.summary.average_mask_coverage)},{label:"Avg alpha weight",value:ee(e.summary.average_alpha_weight)}],n=e.warnings.length?`
      <article class="dataset-analysis-block dataset-analysis-warning">
        <p class="panel-kicker">warnings</p>
        <ul class="dataset-analysis-list-plain">
          ${e.warnings.map(s=>`<li>${o(s)}</li>`).join("")}
    ...
    `)}function ca(e,t,a="caption-backup-results"){if(!e.length){f(a,`
        <article class="dataset-analysis-block">
      ...
      `).join("");f(a,`<div class="dataset-analysis-stack">${n}</div>`)}function pa(e,t="caption-backup-results"){const a=e.warnings.length?`
      <article class="dataset-analysis-block dataset-analysis-warning">
        <p class="panel-kicker">warnings</p>
        <ul class="dataset-analysis-list-plain">
...
This overwrites matching caption files from the snapshot.`)){e.browseButton.disabled=!0,e.createButton.disabled=!0,e.refreshButton.disabled=!0,e.restoreButton.disabled=!0,h("caption-backup-status","Restoring caption snapshot..."),f("caption-backup-results",'<p class="dataset-analysis-empty">Writing snapshot files back to the folder...</p>');try{const s=await Yt({path:t,archive_name:a,make_restore_backup:e.preRestoreInput.checked});if(s.status!=="success"||!s.data)throw new Error(s.message||"Caption snapshot restore failed.");h("caption-backup-status",s.message||`Restored ${s.data.restored_file_count} caption files.`),pa(s.data),await G(e,a,!1)}catch(s){h("caption-backup-status",s instanceof Error?s.message:"Caption snapshot restore failed."),f("caption-backup-results",`<article class="dataset-analysis-block dataset-analysis-warning"><p>${o(s instanceof Error?s.message:"Caption snapshot restore failed.")}</p></article>`)}finally{e.browseButton.disabled=!1,e.createButton.disabled=!1,e.refreshButton.disabled=!1,e.restoreButton.disabled=!1}}}function ae(e,t){const a=Number.parseInt(e,10);return Number.isNaN(a)||a<1?t:a}function We(e,t,a,n){const s=Number.parseFloat(e);return Number.isNaN(s)?t:Math.min(Math.max(s,a),n)}async function be(){var e;try{const t=await Le();na(((e=t.data)==null?void 0:e.tasks)??[]),document.querySelectorAll("[data-task-terminate]").forEach(a=>{a.addEventListener("click",async()=>{const n=a.dataset.taskTerminate;if(n){a.setAttribute("disabled","true");try{await dt(n)}finally{await be()}}})})}catch(t){f("task-table-container",`<p>${t instanceof Error?o(t.message):"Task request failed."}</p>`)}}async function Wa(){const e=document.querySelector("#refresh-tasks");e==null||e.addEventListener("click",()=>{be()}),await be()}class ${constructor(t){x(this,"kind");x(this,"descriptionText");x(this,"defaultValue");x(this,"roleName");x(this,"roleConfig");x(this,"minValue");x(this,"maxValue");x(this,"stepValue");x(this,"disabledFlag",!1);x(this,"requiredFlag",!1);x(this,"literalValue");x(this,"options",[]);x(this,"fields",{});x(this,"itemType");this.kind=t}description(t){return this.descriptionText=t,this}default(t){return this.defaultValue=t,this}role(t,a){return this.roleName=typeof t=="string"?t:"custom",this.roleConfig=a??t,this}min(t){return this.minValue=t,this}max(t){return this.maxValue=t,this}step(t){return this.stepValue=t,this}required(){return this.requiredFlag=!0,this}disabled(){return this.disabledFlag=!0,this}}function M(e){if(e instanceof $)return e;if(e===String)return new $("string");if(e===Number)return new $("number");if(e===Boolean)return new $("boolean");if(typeof e=="string"||typeof e=="number"||typeof e=="boolean"){const t=new $("const");return t.literalValue=e,t.defaultValue=e,t}if(Array.isArray(e)){const t=new $("union");return t.options=e.map(a=>M(a)),t}if(e&&typeof e=="object"){const t=new $("object");return t.fields=Object.fromEntries(Object.entries(e).map(([a,n])=>[a,M(n)])),t}return new $("string")}function Va(){return{string(){return new $("string")},number(){return new $("number")},boolean(){return new $("boolean")},const(e){const t=new $("const");return t.literalValue=e,t.defaultValue=e,t},union(e){const t=new $("union");return t.options=e.map(a=>M(a)),t},intersect(e){const t=new $("intersect");return t.options=e.map(a=>M(a)),t},object(e){const t=new $("object");return t.fields=Object.fromEntries(Object.entries(e).map(([a,n])=>[a,M(n)])),t},array(e){const t=new $("array");return t.itemType=M(e),t}}}function Ga(e,t,a){const n={...e,...t};for(const s of a??[])delete n[s];return n}function Ve(e,t){const a=Va();return new Function("Schema","UpdateSchema","SHARED_SCHEMAS","String","Number","Boolean","source",'"use strict"; return eval(source);')(a,Ga,t??{},String,Number,Boolean,e)}function $t(e){const t=e.find(s=>s.name==="shared"),n=(t?Ve(t.schema,null):{})||{};return e.map(s=>({name:s.name,hash:s.hash,source:s.schema,runtime:s.name==="shared"?n:Ve(s.schema,n)}))}function Ge(e,t=""){return Object.entries(e).map(([a,n])=>({name:a,path:t?`${t}.${a}`:a,schema:n})).filter(a=>a.schema.kind!=="const"||!a.schema.requiredFlag)}function Ke(e){return Object.entries(e).filter(([,t])=>t.kind==="const"&&t.requiredFlag).map(([t,a])=>`${t} = ${String(a.literalValue)}`)}function Je(e){return Object.fromEntries(Object.entries(e).filter(([,t])=>t.kind==="const"&&t.requiredFlag).map(([t,a])=>[t,a.literalValue]))}function ye(e,t,a){if(e.kind==="intersect"){e.options.forEach((n,s)=>ye(n,`${t}-i${s}`,a));return}if(e.kind==="object"){const n=Ge(e.fields);n.length>0&&a.push({id:t,title:e.descriptionText||"Unnamed section",fields:n,conditions:Ke(e.fields),constants:Je(e.fields)});return}e.kind==="union"&&e.options.forEach((n,s)=>{if(n.kind==="object"){const i=Ge(n.fields);i.length>0&&a.push({id:`${t}-u${s}`,title:n.descriptionText||e.descriptionText||`Conditional branch ${s+1}`,fields:i,conditional:!0,conditions:Ke(n.fields),constants:Je(n.fields)})}else ye(n,`${t}-u${s}`,a)})}function Ka(e){const t=[];return ye(e,"section",t),t}function Ja(e){const t={};for(const a of e){a.conditional||Object.assign(t,a.constants);for(const n of a.fields)n.schema.defaultValue!==void 0?t[n.path]=n.schema.defaultValue:n.schema.kind==="boolean"?t[n.path]=!1:t[n.path]=""}return t}function wt(e,t){return e.conditional?Object.entries(e.constants).every(([a,n])=>t[a]===n):!0}function Ya(e,t){const a={...t};for(const n of e){if(wt(n,t)){Object.assign(a,n.constants);continue}for(const s of n.fields)delete a[s.path]}return a}function Re(e){return`field-${e.replaceAll(/[^a-zA-Z0-9_-]/g,"-")}`}function Za(e){if(e.kind!=="union")return null;const t=e.options.filter(a=>a.kind==="const").map(a=>a.literalValue).filter(a=>typeof a=="string"||typeof a=="number"||typeof a=="boolean");return t.length!==e.options.length?null:t}function Qa(e,t){if(!e.roleConfig||typeof e.roleConfig!="object"||Array.isArray(e.roleConfig))return;const a=e.roleConfig[t];return typeof a=="string"?a:void 0}function ve(e){return Array.isArray(e)?e.map(t=>String(t??"")):typeof e=="string"&&e.length>0?e.split(/\r?\n/):[]}function es(e,t,a){const n=ve(t),s=n.length>0?n:[""],i=Re(e.path);return`
  ...
  `}function ts(e,t){const a=e.schema,n=Re(e.path),s=o(e.path),i=Za(a),r=a.disabledFlag?"disabled":"",c=a.roleName||"";if(a.kind==="boolean")return`
    ...
    `;if(a.kind==="array"){if(c==="table")return es(e,t,r);const u=Array.isArray(t)?t.join(`
`):"";return`<textarea id="${n}" class="field-input field-textarea" data-field-path="${s}" data-field-kind="array" ${r}>${o(u)}</textarea>`}if(i){const u=i.map(l=>`<option value="${o(l)}" ${String(l)===String(t)?"selected":""}>${o(l)}</option>`).join("");return`<select id="${n}" class="field-input" data-field-path="${s}" data-field-kind="enum" ${r}>${u}</select>`}if(a.kind==="number"){const u=a.minValue!==void 0?`min="${a.minValue}"`:"",l=a.maxValue!==void 0?`max="${a.maxValue}"`:"",p=a.stepValue!==void 0?`step="${a.stepValue}"`:'step="any"';if(c==="slider"&&a.minValue!==void 0&&a.maxValue!==void 0){const d=t===""||t===void 0||t===null?a.defaultValue??a.minValue:t;return`
        <div class="slider-editor">
          ...
          <div class="slider-editor-footer">
            <input
              ...
              ${r}
            />
            <span class="slider-value" data-slider-value-for="${s}">${o(d)}</span>
          </div>
        </div>
      `}return`<input id="${n}" class="field-input" data-field-path="${s}" data-field-kind="number" type="number" value="${o(t)}" ${u} ${l} ${p} ${r} />`}if(c==="textarea")return`<textarea id="${n}" class="field-input field-textarea" data-field-path="${s}" data-field-kind="string" ${r}>${o(t)}</textarea>`;if(c==="filepicker"){const u=Qa(a,"type")??(e.path.endsWith("_dir")||e.path==="resume"?"folder":"model-file");return`
  ...
  `}function xt(e){return e.sections.filter(t=>wt(t,e.values))}function St(e){return Ya(e.sections,e.values)}function ss(e,t){const a=xt(e);if(a.length===0){f(t,"<p>No renderable sections extracted from this schema.</p>");return}const n=a.map(s=>{const i=s.fields.map(c=>as(c,e.values[c.path])).join(""),r=s.conditions.length?`<div class="condition-list">${s.conditions.map(c=>`<span class="coverage-pill coverage-pill-muted">${o(c)}</span>`).join("")}</div>`:"";return`
      ...
      `}).join("");f(t,n)}function ke(e,t){const a=Object.fromEntries(Object.entries(St(e)).sort(([n],[s])=>n.localeCompare(s)));U(t,JSON.stringify(a,null,2))}function ce(e){return e.filter(t=>t.name!=="shared"&&t.runtime instanceof $)}function Ye(e,t){const a=e.schema;if(a.kind==="boolean")return!!t;if(a.kind==="number"){const n=String(t).trim();if(n==="")return"";const s=Number(n);return Number.isNaN(s)?"":s}return a.kind==="array"?String(t).split(/\r?\n/).map(n=>n.trim()).filter(Boolean):t}function Ze(e,t){return e.sections.flatMap(a=>a.fields).find(a=>a.path===t)}function ns(e,t){return[...e.querySelectorAll('[data-field-kind="table-row"]')].filter(a=>a.dataset.fieldPath===t).map(a=>a.value.trim()).filter(Boolean)}function Qe(e,t,a,n){const s=String(a??"");e.querySelectorAll("[data-field-path]").forEach(i=>{if(!(i===n||i.dataset.fieldPath!==t||i.dataset.fieldKind==="table-row")){if(i instanceof HTMLInputElement&&i.type==="checkbox"){i.checked=!!a;return}i.value=s}}),e.querySelectorAll("[data-slider-value-for]").forEach(i=>{i.dataset.sliderValueFor===t&&(i.textContent=s)})}function ue(e,t,a,n="idle"){e.querySelectorAll("[data-picker-status-for]").forEach(s=>{s.dataset.pickerStatusFor===t&&(s.textContent=a,s.classList.remove("is-success","is-error"),n==="success"?s.classList.add("is-success"):n==="error"&&s.classList.add("is-error"))})}function is(e,t,a,n){const s=document.querySelector(`#${t.sectionsId}`);if(!s)return;const i=new Set(e.sections.flatMap(r=>r.conditional?Object.keys(r.constants):[]));s.querySelectorAll("[data-field-path]").forEach(r=>{const c=r.dataset.fieldKind,u=r instanceof HTMLInputElement&&r.type==="checkbox"||r instanceof HTMLSelectElement?"change":"input";r.addEventListener(u,()=>{const l=r.dataset.fieldPath;if(!l)return;const p=Ze(e,l);if(p){if(c==="table-row")e.values[l]=ns(s,l);else{const d=r instanceof HTMLInputElement&&r.type==="checkbox"?r.checked:r.value;e.values[l]=Ye(p,d),Qe(s,l,e.values[l],r)}if(i.has(l)){n({...e,values:{...e.values}});return}ke(e,t.previewId),a(e)}})}),s.querySelectorAll("[data-table-add]").forEach(r=>{r.addEventListener("click",()=>{const c=r.dataset.tableAdd;c&&(e.values[c]=[...ve(e.values[c]),""],n({...e,values:{...e.values}}))})}),s.querySelectorAll("[data-table-remove]").forEach(r=>{r.addEventListener("click",()=>{const c=r.dataset.tableRemove,u=Number(r.dataset.tableIndex??"-1");if(!c||u<0)return;const l=ve(e.values[c]).filter((p,d)=>d!==u);e.values[c]=l,n({...e,values:{...e.values}})})}),s.querySelectorAll("[data-picker-path]").forEach(r=>{r.addEventListener("click",async()=>{const c=r.dataset.pickerPath,u=r.dataset.pickerType||"model-file";if(!c)return;const l=Ze(e,c);if(l){r.setAttribute("disabled","true"),ue(s,c,"Waiting for native picker...","idle");try{const p=await O(u);if(e.values[c]=Ye(l,p),Qe(s,c,e.values[c]),ue(s,c,p,"success"),i.has(c)){n({...e,values:{...e.values}});return}ke(e,t.previewId),a(e)}catch(p){ue(s,c,p instanceof Error?p.message:"The picker failed to return a value.","error")}finally{r.removeAttribute("disabled")}}})})}function se(e,t){const a=ce(e).find(s=>s.name===t);if(!a||!(a.runtime instanceof $))return null;const n=Ka(a.runtime);return{catalog:e,selectedName:t,sections:n,values:Ja(n)}}function K(e,t,a,n){if(a(e),!e){h(t.summaryId,"Failed to build schema bridge state."),f(t.sectionsId,"<p>Schema bridge failed to initialize.</p>"),U(t.previewId,"{}");return}const i=ce(e.catalog).map(l=>`<option value="${o(l.name)}" ${l.name===e.selectedName?"selected":""}>${o(l.name)}</option>`).join(""),r=xt(e);f(t.selectId,i),h(t.summaryId,`${e.selectedName} · ${r.length}/${e.sections.length} visible sections · ${r.reduce((l,p)=>l+p.fields.length,0)} visible fields`),ss(e,t.sectionsId),ke(e,t.previewId);const c=document.querySelector(`#${t.selectId}`);c&&(c.onchange=()=>{const l=se(e.catalog,c.value);K(l,t,a,n)});const u=document.querySelector(`#${t.resetId}`);u&&(u.onclick=()=>{K(se(e.catalog,e.selectedName),t,a,n)}),is(e,t,n,l=>K(l,t,a,n)),n(e)}const rs={selectId:"schema-select",summaryId:"schema-summary",sectionsId:"schema-sections",previewId:"schema-preview",resetId:"schema-reset"};function os(e){return{selectId:`${e}-schema-select`,summaryId:`${e}-summary`,sectionsId:`${e}-sections`,previewId:`${e}-preview`,resetId:`${e}-reset`}}async function ls(e){var t,a,n;try{const i=((t=(await Te()).data)==null?void 0:t.schemas)??[],r=$t(i),c=ce(r),u=((a=c.find(l=>l.name==="sdxl-lora"))==null?void 0:a.name)??((n=c[0])==null?void 0:n.name);if(!u){h("schema-summary","No selectable schemas were returned."),f("schema-sections","<p>No schema runtime available.</p>");return}K(se(r,u),rs,e,()=>{})}catch(s){h("schema-summary","Schema bridge request failed"),f("schema-sections",`<p>${s instanceof Error?o(s.message):"Unknown error"}</p>`),U("schema-preview","{}")}}function cs(e,t){return`
    <div class="app-shell">
...
`),a==="base_weights"&&(t.enable_base_weight=!0),a==="base_weights_multiplier"&&(t.enable_base_weight=!0));return Array.isArray(t.gpu_ids)&&(t.gpu_ids=t.gpu_ids.map(a=>_(a))),t}function X(e,t){return`
  ...
  `}function re(e){return typeof e=="string"&&e.trim().length>0?e.trim():null}function we(e,t){const a=t.metadata??{},n=re(a.train_type);return n?e.presetTrainTypes.includes(n)?{compatible:!0,label:"route preset",detail:`Preset metadata matches this route via train_type = ${n}.`,tone:"default"}:{compatible:!1,label:"cross-route preset",detail:`Preset metadata targets ${n}, which does not match ${e.schemaName}.`,tone:"warning"}:{compatible:!0,label:"generic preset",detail:"This preset does not declare a train_type, so review route-specific fields before launch.",tone:"muted"}}function xe(e,t){const a=re(t.route_id),n=re(t.train_type);return a===e.routeId?{compatible:!0,label:"route recipe",detail:"This recipe was saved from the same source-side route.",tone:"default"}:n&&e.presetTrainTypes.includes(n)?{compatible:!0,label:"family recipe",detail:`Recipe metadata matches this route family via train_type = ${n}.`,tone:"default"}:!a&&!n?{compatible:!0,label:"generic recipe",detail:"This recipe has no route metadata, so review route-specific fields before applying it.",tone:"muted"}:a?{compatible:!1,label:"cross-route recipe",detail:`Recipe metadata says it came from ${a}, not ${e.routeId}.`,tone:"warning"}:{compatible:!1,label:"foreign train type",detail:`Recipe metadata targets ${n}, which does not match ${e.schemaName}.`,tone:"warning"}}function J(e,t){const a=t.values.output_name;return typeof a=="string"&&a.trim().length>0?a.trim():`${e.modelLabel} snapshot`}function an(e){try{return JSON.stringify(Fe(H(e.value)),null,2)}catch(t){return t instanceof Error?t.message:"Unable to preview this snapshot."}}function sn(e,t){if(t.length===0){f(`${e}-history-panel`,`
    ...
    `)}function nn(e,t,a){if(t.length===0){f(`${e}-presets-panel`,`
      ...
      `);return}const n=t.map((s,i)=>{const r=s.metadata??{},c=s.data??{},u=we(a,s),l=u.tone==="warning"?"coverage-pill-warning":u.tone==="muted"?"coverage-pill-muted":"",p=re(r.train_type);return`
        <article class="preset-card">
          ...
          <div class="coverage-list training-card-compatibility">
            <span class="coverage-pill ${l}">${o(u.label)}</span>
            ${p?`<span class="coverage-pill coverage-pill-muted">${o(p)}</span>`:""}
          </div>
          <p class="training-card-note">${o(u.detail)}</p>
    ...
    `)}function rn(e,t,a){if(t.length===0){f(`${e}-recipes-panel`,`
      ...
      <div class="preset-list">${n}</div>
    `)}function on(e,t){const a=new Set(e.presetTrainTypes);return t.filter(n=>{const i=(n.metadata??{}).train_type;return typeof i!="string"||i.trim().length===0?!0:a.has(i)})}function T(e,t,a){const n=document.querySelector(`#${e}-history-panel`),s=document.querySelector(`#${e}-recipes-panel`),i=document.querySelector(`#${e}-presets-panel`);n&&(n.hidden=t==="history"?!a:!0),s&&(s.hidden=t==="recipes"?!a:!0),i&&(i.hidden=t==="presets"?!a:!0)}async function rt(e,t){try{const a=await Qt(t);if(a.status!=="success")throw new Error(a.message||"Training preflight failed.");return tt(e.prefix,a.data??null),a.data??null}catch(a){throw tt(e.prefix,null,a instanceof Error?a.message:"Training preflight failed."),a}}function ln(e){var t;(t=document.querySelector(`#${e.prefix}-stop-train`))==null||t.addEventListener("click",async()=>{var a;try{const s=(((a=(await Le()).data)==null?void 0:a.tasks)??[]).find(r=>String(r.status).toUpperCase()==="RUNNING");if(!s){y(e.prefix,"No running training task was found.","warning");return}const i=String(s.id??s.task_id??"");if(!i){y(e.prefix,"The running task does not expose an id.","error");return}if(!window.confirm(`Stop running task ${i}?`))return;await dt(i),I(e.prefix,"Training stop requested",`Sent terminate request for task ${i}.`,"warning"),y(e.prefix,`Terminate requested for task ${i}.`,"warning")}catch(n){y(e.prefix,n instanceof Error?n.message:"Failed to stop training.","error")}})}function cn(e,t,a){var s;(s=document.querySelector(`#${e.prefix}-run-preflight`))==null||s.addEventListener("click",async()=>{const i=t();if(!i){I(e.prefix,"Editor not ready",`The ${e.modelLabel} schema editor state is not initialized yet.`,"error");return}try{const r=a(i);ne(e.prefix,r.checks),await rt(e,r.payload),y(e.prefix,"Training preflight completed.","success")}catch(r){y(e.prefix,r instanceof Error?r.message:"Training preflight failed.","error")}});const n=document.querySelector(`#${e.prefix}-start-train`);n==null||n.addEventListener("click",async()=>{var r;const i=t();if(!i){I(e.prefix,"Editor not ready",`The ${e.modelLabel} schema editor state is not initialized yet.`,"error");return}n.setAttribute("disabled","true"),I(e.prefix,"Submitting training job...","Sending the current payload to /api/run.","idle");try{const c=a(i);if(c.checks.errors.length>0){I(e.prefix,"Fix parameter conflicts first",c.checks.errors.join(" "),"error"),ne(e.prefix,c.checks);return}const u=await rt(e,c.payload);if(u&&!u.can_start){I(e.prefix,"Resolve preflight errors first",u.errors.join(" "),"error");return}const l=await Zt(c.payload);if(l.status==="success"){const d=[...c.checks.warnings,...(u==null?void 0:u.warnings)??[],...((r=l.data)==null?void 0:r.warnings)??[]].join(" ");I(e.prefix,"Training request accepted",`${l.message||"Training started."}${d?` ${d}`:""}`,d?"warning":"success")}else I(e.prefix,"Training request failed",l.message||"Unknown backend failure.","error")}catch(c){I(e.prefix,"Training request failed",c instanceof Error?c.message:"Unknown network error.","error")}finally{n.removeAttribute("disabled")}})}function pn(e){return e.trim().replace(/[^0-9A-Za-z._-]+/g,"-").replace(/-+/g,"-").replace(/^[-_.]+|[-_.]+$/g,"")||"training-preset"}function dn(e,t,a){const n=J(e,t),s=String(a.payload.model_train_type??"");return{metadata:{name:n,version:"1.0",author:"SD-reScripts local export",train_type:s||e.schemaName,description:`Exported from the ${e.modelLabel} source-side training bridge on ${new Date().toLocaleString()}.`},data:a.payload}}function un(e,t,a,n){const s=J(e,t),i=window.prompt("Recipe name",s);if(!i||!i.trim())return!1;const r=window.prompt("Recipe description (optional)","")??"",c=E(e.routeId);return c.unshift({created_at:new Date().toLocaleString(),name:i.trim(),description:r.trim()||void 0,train_type:String(a.payload.model_train_type??e.schemaName),route_id:e.routeId,value:H(a.payload)}),V(e.routeId,Ne(c)),n(),!0}function ot(e,t,a){const n=t.data&&typeof t.data=="object"&&!Array.isArray(t.data)?t.data:t.value&&typeof t.value=="object"&&!Array.isArray(t.value)?t.value:t;if(!n||typeof n!="object"||Array.isArray(n)||Object.keys(n).length===0)return null;const s=t.metadata&&typeof t.metadata=="object"&&!Array.isArray(t.metadata)?t.metadata:{},i=String(s.name||t.name||a||"Imported recipe").trim();return{created_at:String(t.created_at||new Date().toLocaleString()),name:i||"Imported recipe",description:typeof s.description=="string"?s.description:typeof t.description=="string"?t.description:void 0,train_type:typeof s.train_type=="string"?s.train_type:typeof t.train_type=="string"?t.train_type:typeof n.model_train_type=="string"?n.model_train_type:e.schemaName,route_id:typeof t.route_id=="string"?t.route_id:e.routeId,value:H(n)}}function hn(e,t,a){const n=a.trim();if(!n)throw new Error("Recipe file is empty.");const s=t.toLowerCase().endsWith(".json")?JSON.parse(n):qe(n),i=[];if(Array.isArray(s))s.forEach((r,c)=>{if(!r||typeof r!="object"||Array.isArray(r))return;const u=ot(e,r,`Imported recipe ${c+1}`);u&&i.push(u)});else if(s&&typeof s=="object"){const r=ot(e,s,t.replace(/\.[^.]+$/,""));r&&i.push(r)}if(i.length===0)throw new Error("No valid recipe entries were found in this file.");return i}function mn(e,t,a){var s;const n=B(e.routeId);n.unshift({time:new Date().toLocaleString(),name:J(e,t),value:H(t.values),gpu_ids:Ce(`${e.prefix}-gpu-selector`)}),te(e.routeId,_t(n)),(s=document.querySelector(`#${e.prefix}-history-panel`))!=null&&s.hidden||a()}function gn(e,t,a,n){var s,i,r,c;(s=document.querySelector(`#${e.prefix}-download-config`))==null||s.addEventListener("click",()=>{const u=t();if(!u)return;const l=a(u);z(`${e.prefix}-${ge()}.toml`,_e(l.payload)),y(e.prefix,"Exported current config as TOML.","success")}),(i=document.querySelector(`#${e.prefix}-export-preset`))==null||i.addEventListener("click",()=>{const u=t();if(!u)return;const l=a(u),p=dn(e,u,l),d=pn(J(e,u)||e.prefix);z(`${d}-preset.toml`,_e(p)),y(e.prefix,"Exported current config as reusable preset TOML.","success")}),(r=document.querySelector(`#${e.prefix}-import-config`))==null||r.addEventListener("click",()=>{var u;(u=document.querySelector(`#${e.prefix}-config-file-input`))==null||u.click()}),(c=document.querySelector(`#${e.prefix}-config-file-input`))==null||c.addEventListener("change",u=>{var g;const l=u.currentTarget,p=(g=l.files)==null?void 0:g[0];if(!p)return;const d=new FileReader;d.onload=()=>{try{const m=qe(String(d.result??"")),b=m.data&&typeof m.data=="object"&&!Array.isArray(m.data)?m.data:m;n(b),y(e.prefix,m.data&&typeof m.data=="object"?`Imported preset: ${p.name}.`:`Imported config: ${p.name}.`,"success")}catch(m){y(e.prefix,m instanceof Error?m.message:"Failed to import config.","error")}finally{l.value=""}},d.readAsText(p)})}function fn(e,t){var a;(a=document.querySelector(`#${e.prefix}-history-file-input`))==null||a.addEventListener("change",n=>{var c;const s=n.currentTarget,i=(c=s.files)==null?void 0:c[0];if(!i)return;const r=new FileReader;r.onload=()=>{try{const u=JSON.parse(String(r.result??""));if(!Array.isArray(u))throw new Error("History file must contain an array.");const l=u.filter(d=>d&&typeof d=="object"&&d.value&&typeof d.value=="object").map(d=>({time:String(d.time||new Date().toLocaleString()),name:d.name?String(d.name):void 0,value:H(d.value),gpu_ids:Array.isArray(d.gpu_ids)?d.gpu_ids.map(g=>String(g)):[]}));if(l.length===0)throw new Error("History file did not contain valid entries.");const p=_t([...B(e.routeId),...l]);te(e.routeId,p),t(),y(e.prefix,`Imported ${l.length} history entries.`,"success")}catch(u){y(e.prefix,u instanceof Error?u.message:"Failed to import history.","error")}finally{s.value=""}},r.readAsText(i)})}function bn(e,t,a){var n;(n=document.querySelector(`#${e.prefix}-recipe-file-input`))==null||n.addEventListener("change",s=>{var u;const i=s.currentTarget,r=(u=i.files)==null?void 0:u[0];if(!r)return;const c=new FileReader;c.onload=()=>{try{const l=hn(e,r.name,String(c.result??"")),p=Ne([...l,...E(e.routeId)]);V(e.routeId,p),t(),a(),y(e.prefix,`Imported ${l.length} recipe ${l.length===1?"entry":"entries"}.`,"success")}catch(l){y(e.prefix,l instanceof Error?l.message:"Failed to import recipe.","error")}finally{i.value=""}},c.readAsText(r)})}function yn(e,t,a){f(`${e}-sample-prompt-workspace`,`
      <div class="submit-status-box">
        <strong>${o(t)}</strong>
        <p>${o(a)}</p>
      </div>
    ...
    `)}async function lt(e,t,a){const n=t();if(!n)throw new Error(`${e.modelLabel} editor is not ready yet.`);const s=a(n),i=await ea(s.payload);if(i.status!=="success"||!i.data)throw new Error(i.message||"Sample prompt preview failed.");return i.data}function kn(e){var i,r,c,u;const{config:t,getCurrentState:a,buildPreparedTrainingPayload:n,applyEditableRecord:s}=e;(i=document.querySelector(`#${t.prefix}-refresh-sample-prompt`))==null||i.addEventListener("click",async()=>{try{const l=await lt(t,a,n);Q(t.prefix,l),y(t.prefix,"Sample prompt preview refreshed.","success")}catch(l){Q(t.prefix,null,l instanceof Error?l.message:"Sample prompt preview failed."),y(t.prefix,l instanceof Error?l.message:"Sample prompt preview failed.","error")}}),(r=document.querySelector(`#${t.prefix}-download-sample-prompt`))==null||r.addEventListener("click",async()=>{try{const l=await lt(t,a,n);Q(t.prefix,l),z(l.suggested_file_name||"sample-prompts.txt",l.content||""),y(t.prefix,`Sample prompt exported as ${l.suggested_file_name}.`,"success")}catch(l){Q(t.prefix,null,l instanceof Error?l.message:"Sample prompt export failed."),y(t.prefix,l instanceof Error?l.message:"Sample prompt export failed.","error")}}),(c=document.querySelector(`#${t.prefix}-pick-prompt-file`))==null||c.addEventListener("click",async()=>{try{const l=await O("text-file");s({prompt_file:l},void 0,"merge"),oe(t.prefix),y(t.prefix,"Prompt file path inserted into the current form state.","success")}catch(l){y(t.prefix,l instanceof Error?l.message:"Prompt file picker failed.","error")}}),(u=document.querySelector(`#${t.prefix}-clear-prompt-file`))==null||u.addEventListener("click",()=>{s({prompt_file:""},void 0,"merge"),oe(t.prefix),y(t.prefix,"prompt_file cleared from the current form state.","warning")})}function _n(e){var m,b,v,S,D,W,je,Oe;const{config:t,createDefaultState:a,getCurrentState:n,mountTrainingState:s,onStateChange:i,applyEditableRecord:r,buildPreparedTrainingPayload:c,bindHistoryPanel:u,bindRecipePanel:l,openHistoryPanel:p,openRecipePanel:d,openPresetPanel:g}=e;document.querySelectorAll(`#${t.prefix}-gpu-selector input[data-gpu-id]`).forEach(L=>{L.addEventListener("change",()=>{const Y=n();Y&&i(Y)})}),(m=document.querySelector(`#${t.prefix}-reset-all`))==null||m.addEventListener("click",()=>{const L=a();De(t.prefix,[]),s(L),y(t.prefix,"Reset to schema defaults.","warning")}),(b=document.querySelector(`#${t.prefix}-save-params`))==null||b.addEventListener("click",()=>{const L=n();L&&(mn(t,L,u),y(t.prefix,"Current parameters saved to history.","success"))}),(v=document.querySelector(`#${t.prefix}-read-params`))==null||v.addEventListener("click",()=>{p()}),(S=document.querySelector(`#${t.prefix}-clear-autosave`))==null||S.addEventListener("click",()=>{window.confirm("Clear the local autosave for this training route?")&&(Sa(t.routeId),Be(t.prefix,null),y(t.prefix,"Cleared local autosave for this route.","warning"))}),(D=document.querySelector(`#${t.prefix}-save-recipe`))==null||D.addEventListener("click",()=>{const L=n();if(!L)return;const Y=c(L);un(t,L,Y,l)&&y(t.prefix,"Current config saved to the local recipe library.","success")}),(W=document.querySelector(`#${t.prefix}-read-recipes`))==null||W.addEventListener("click",()=>{d()}),(je=document.querySelector(`#${t.prefix}-import-recipe`))==null||je.addEventListener("click",()=>{var L;(L=document.querySelector(`#${t.prefix}-recipe-file-input`))==null||L.click()}),(Oe=document.querySelector(`#${t.prefix}-load-presets`))==null||Oe.addEventListener("click",()=>{g()}),gn(t,n,c,r),fn(t,p),bn(t,l,d),kn({config:t,getCurrentState:n,buildPreparedTrainingPayload:c,applyEditableRecord:r}),ln(t),cn(t,n,c)}function $n(e,t){let a=null;const n=(p,d,g)=>window.confirm(`Apply ${p} "${d}" to ${e.modelLabel}?

${g}

You can still continue, but some route-specific fields may need manual review afterwards.`),s=()=>{const p=B(e.routeId);sn(e.prefix,p),document.querySelectorAll(`#${e.prefix}-history-panel [data-history-close]`).forEach(d=>{d.addEventListener("click",()=>T(e.prefix,"history",!1))}),document.querySelectorAll(`#${e.prefix}-history-panel [data-history-export]`).forEach(d=>{d.addEventListener("click",()=>{z(`${e.prefix}-history-${ge()}.json`,JSON.stringify(B(e.routeId),null,2),"application/json;charset=utf-8"),y(e.prefix,"History exported.","success")})}),document.querySelectorAll(`#${e.prefix}-history-panel [data-history-import]`).forEach(d=>{d.addEventListener("click",()=>{var g;(g=document.querySelector(`#${e.prefix}-history-file-input`))==null||g.click()})}),document.querySelectorAll(`#${e.prefix}-history-panel [data-history-apply]`).forEach(d=>{d.addEventListener("click",()=>{const g=Number(d.dataset.historyApply??"-1"),m=B(e.routeId)[g];m&&(t(m.value,m.gpu_ids,"replace"),T(e.prefix,"history",!1),y(e.prefix,`Applied snapshot: ${m.name||"Unnamed snapshot"}.`,"success"))})}),document.querySelectorAll(`#${e.prefix}-history-panel [data-history-rename]`).forEach(d=>{d.addEventListener("click",()=>{const g=Number(d.dataset.historyRename??"-1"),m=B(e.routeId),b=m[g];if(!b)return;const v=window.prompt("Rename snapshot",b.name||"");v&&(b.name=v.trim(),te(e.routeId,m),s(),y(e.prefix,"Snapshot renamed.","success"))})}),document.querySelectorAll(`#${e.prefix}-history-panel [data-history-delete]`).forEach(d=>{d.addEventListener("click",()=>{const g=Number(d.dataset.historyDelete??"-1"),m=B(e.routeId),b=m[g];b&&window.confirm(`Delete snapshot "${b.name||"Unnamed snapshot"}"?`)&&(m.splice(g,1),te(e.routeId,m),s(),y(e.prefix,"Snapshot deleted.","success"))})})},i=()=>{s(),T(e.prefix,"history",!0)},r=()=>{const p=E(e.routeId);rn(e.prefix,p,e),document.querySelectorAll(`#${e.prefix}-recipes-panel [data-recipe-close]`).forEach(d=>{d.addEventListener("click",()=>T(e.prefix,"recipes",!1))}),document.querySelectorAll(`#${e.prefix}-recipes-panel [data-recipe-export-all]`).forEach(d=>{d.addEventListener("click",()=>{z(`${e.prefix}-recipes-${ge()}.json`,JSON.stringify(E(e.routeId),null,2),"application/json;charset=utf-8"),y(e.prefix,"Recipe library exported.","success")})}),document.querySelectorAll(`#${e.prefix}-recipes-panel [data-recipe-import]`).forEach(d=>{d.addEventListener("click",()=>{var g;(g=document.querySelector(`#${e.prefix}-recipe-file-input`))==null||g.click()})}),document.querySelectorAll(`#${e.prefix}-recipes-panel [data-recipe-merge]`).forEach(d=>{d.addEventListener("click",()=>{const g=Number(d.dataset.recipeMerge??"-1"),m=E(e.routeId)[g];if(!m)return;const b=xe(e,m);!b.compatible&&!n("recipe",m.name,b.detail)||(t(m.value,void 0,"merge"),T(e.prefix,"recipes",!1),y(e.prefix,`Merged recipe: ${m.name}.`,"success"))})}),document.querySelectorAll(`#${e.prefix}-recipes-panel [data-recipe-replace]`).forEach(d=>{d.addEventListener("click",()=>{const g=Number(d.dataset.recipeReplace??"-1"),m=E(e.routeId)[g];if(!m)return;const b=xe(e,m);!b.compatible&&!n("recipe",m.name,b.detail)||(t(m.value,void 0,"replace"),T(e.prefix,"recipes",!1),y(e.prefix,`Replaced current values with recipe: ${m.name}.`,"success"))})}),document.querySelectorAll(`#${e.prefix}-recipes-panel [data-recipe-export]`).forEach(d=>{d.addEventListener("click",()=>{const g=Number(d.dataset.recipeExport??"-1"),m=E(e.routeId)[g];m&&(z(`${m.name.replace(/[^0-9A-Za-z._-]+/g,"-")||"recipe"}-preset.toml`,_e({metadata:{name:m.name,version:"1.0",author:"SD-reScripts local recipe",train_type:m.train_type||e.schemaName,description:m.description||`Exported recipe from ${e.modelLabel}.`},data:m.value})),y(e.prefix,`Exported recipe: ${m.name}.`,"success"))})}),document.querySelectorAll(`#${e.prefix}-recipes-panel [data-recipe-rename]`).forEach(d=>{d.addEventListener("click",()=>{const g=Number(d.dataset.recipeRename??"-1"),m=E(e.routeId),b=m[g];if(!b)return;const v=window.prompt("Rename recipe",b.name);!v||!v.trim()||(b.name=v.trim(),V(e.routeId,m),r(),y(e.prefix,"Recipe renamed.","success"))})}),document.querySelectorAll(`#${e.prefix}-recipes-panel [data-recipe-delete]`).forEach(d=>{d.addEventListener("click",()=>{const g=Number(d.dataset.recipeDelete??"-1"),m=E(e.routeId),b=m[g];b&&window.confirm(`Delete recipe "${b.name}"?`)&&(m.splice(g,1),V(e.routeId,m),r(),y(e.prefix,"Recipe deleted.","success"))})})},c=()=>{r(),T(e.prefix,"recipes",!0)},u=()=>{nn(e.prefix,a??[],e),document.querySelectorAll(`#${e.prefix}-presets-panel [data-preset-close]`).forEach(p=>{p.addEventListener("click",()=>T(e.prefix,"presets",!1))}),document.querySelectorAll(`#${e.prefix}-presets-panel [data-preset-merge]`).forEach(p=>{p.addEventListener("click",()=>{const d=Number(p.dataset.presetMerge??"-1"),g=a==null?void 0:a[d];if(!g)return;const m=we(e,g),b=String((g.metadata??{}).name||g.name||"preset");if(!m.compatible&&!n("preset",b,m.detail))return;const v=g.data??{};t(v,void 0,"merge"),T(e.prefix,"presets",!1),y(e.prefix,`Merged preset: ${b}.`,"success")})}),document.querySelectorAll(`#${e.prefix}-presets-panel [data-preset-save-recipe]`).forEach(p=>{p.addEventListener("click",()=>{var S;const d=Number(p.dataset.presetSaveRecipe??"-1"),g=a==null?void 0:a[d];if(!g)return;const m=g.metadata??{},b=g.data??{},v=E(e.routeId);v.unshift({created_at:new Date().toLocaleString(),name:String(m.name||g.name||"Imported preset recipe"),description:typeof m.description=="string"?m.description:void 0,train_type:typeof m.train_type=="string"?m.train_type:e.schemaName,route_id:e.routeId,value:JSON.parse(JSON.stringify(b))}),V(e.routeId,Ne(v)),(S=document.querySelector(`#${e.prefix}-recipes-panel`))!=null&&S.hidden||r(),y(e.prefix,`Saved preset to local recipe library: ${String(m.name||g.name||"preset")}.`,"success")})}),document.querySelectorAll(`#${e.prefix}-presets-panel [data-preset-replace]`).forEach(p=>{p.addEventListener("click",()=>{const d=Number(p.dataset.presetReplace??"-1"),g=a==null?void 0:a[d];if(!g)return;const m=we(e,g),b=String((g.metadata??{}).name||g.name||"preset");if(!m.compatible&&!n("preset",b,m.detail))return;const v=g.data??{};t(v,void 0,"replace"),T(e.prefix,"presets",!1),y(e.prefix,`Replaced current values with preset: ${b}.`,"success")})})};return{bindHistoryPanel:s,bindRecipePanel:r,openHistoryPanel:i,openRecipePanel:c,openPresetPanel:async()=>{var p;if(!a)try{const d=await pt();a=on(e,((p=d.data)==null?void 0:p.presets)??[])}catch(d){y(e.prefix,d instanceof Error?d.message:"Failed to load presets.","error");return}u(),T(e.prefix,"presets",!0)}}}async function wn(e){var c,u,l,p;const t=os(e.prefix),[a,n]=await Promise.allSettled([Te(),ut()]);if(n.status==="fulfilled"){const d=((c=n.value.data)==null?void 0:c.cards)??[],g=(u=n.value.data)==null?void 0:u.xformers;Bs(`${e.prefix}-gpu-selector`,d),h(`${e.prefix}-runtime-title`,`${d.length} GPU entries reachable`),f(`${e.prefix}-runtime-body`,`
        <p>${o(ft(d))}</p>
        <p>${o(g?`xformers: ${g.installed?"installed":"missing"}, ${g.supported?"supported":"fallback"} (${g.reason})`:"xformers info unavailable")}</p>
      `)}else h(`${e.prefix}-runtime-title`,"GPU runtime request failed"),h(`${e.prefix}-runtime-body`,n.reason instanceof Error?n.reason.message:"Unknown error");if(a.status!=="fulfilled")return h(t.summaryId,`${e.modelLabel} schema request failed`),f(t.sectionsId,`<p>${a.reason instanceof Error?o(a.reason.message):"Unknown error"}</p>`),U(t.previewId,"{}"),I(e.prefix,"Schema unavailable",`The ${e.modelLabel} training bridge could not load the backend schema.`,"error"),null;const s=((l=a.value.data)==null?void 0:l.schemas)??[],i=$t(s),r=(p=ce(i).find(d=>d.name===e.schemaName))==null?void 0:p.name;return r?{domIds:t,createDefaultState:()=>se(i,r)}:(h(t.summaryId,`No ${e.schemaName} schema was returned.`),f(t.sectionsId,`<p>The backend did not expose ${o(e.schemaName)}.</p>`),I(e.prefix,"Schema missing",`The backend did not expose the ${e.schemaName} schema.`,"error"),null)}const ct={};function xn(e,t){const a=St(t),n=Ce(`${e}-gpu-selector`);n.length>0&&(a.gpu_ids=n);const s=Fe(a);return{payload:s,checks:tn(s)}}function Nt(e){return new Set(e.sections.flatMap(t=>t.fields.map(a=>a.path)))}function Rt(e,t){const a=Nt(e),n={...e.values};for(const[s,i]of Object.entries(t))a.has(s)&&(n[s]=i);return{...e,values:n}}function Sn(e,t){return{...e,values:{...e.values,...Object.fromEntries(Object.entries(t).filter(([a])=>Nt(e).has(a)))}}}function Tn(e,t){return t&&t.length>0?t.map(a=>String(a)):Array.isArray(e.gpu_ids)?e.gpu_ids.map(a=>String(a)):[]}function Ln(e,t){const a={time:new Date().toLocaleString(),name:J(e,t),value:H(t.values),gpu_ids:Ce(`${e.prefix}-gpu-selector`)};xa(e.routeId,a),Be(e.prefix,a)}function In(e){const{config:t,createDefaultState:a,mountTrainingState:n}=e,s=wa(t.routeId);Be(t.prefix,s);const i=s!=null&&s.value?Rt(a(),Pt(s.value)):a();(s==null?void 0:s.gpu_ids)!==void 0&&De(t.prefix,s.gpu_ids),n(i),s!=null&&s.value&&y(t.prefix,"Restored autosaved parameters for this route.","success")}function An(e,t,a,n,s){return i=>{try{const r=a(i),c=Object.fromEntries(Object.entries(r.payload).sort(([u],[l])=>u.localeCompare(l)));U(t.previewId,JSON.stringify(c,null,2)),ne(e.prefix,r.checks)}catch(r){U(t.previewId,"{}"),ne(e.prefix,{warnings:[],errors:[]},r instanceof Error?r.message:"The current state could not be converted into a launch payload.")}n(i),s==null||s()}}function En(e,t,a){const n=()=>ct[e.routeId],s=l=>xn(e.prefix,l),i=An(e,t,s,l=>Ln(e,l),()=>oe(e.prefix)),r=l=>{K(l,t,p=>{ct[e.routeId]=p},i)};return{getCurrentState:n,prepareTrainingPayload:s,onStateChange:i,mountTrainingState:r,applyEditableRecord:(l,p,d="replace")=>{const g=d==="merge"?n()??a():a(),m=Pt(l),b=d==="merge"?Sn(g,m):Rt(g,m);De(e.prefix,Tn(m,p)),r(b)},restoreAutosave:()=>In({config:e,createDefaultState:a,mountTrainingState:r})}}async function Pn(e){const t=await wn(e);if(!t)return;const a=En(e,t.domIds,t.createDefaultState),n=$n(e,a.applyEditableRecord);a.restoreAutosave(),_n({config:e,createDefaultState:t.createDefaultState,getCurrentState:a.getCurrentState,mountTrainingState:a.mountTrainingState,onStateChange:a.onStateChange,applyEditableRecord:a.applyEditableRecord,buildPreparedTrainingPayload:a.prepareTrainingPayload,bindHistoryPanel:n.bindHistoryPanel,bindRecipePanel:n.bindRecipePanel,openHistoryPanel:n.openHistoryPanel,openRecipePanel:n.openRecipePanel,openPresetPanel:n.openPresetPanel}),I(e.prefix,`${e.modelLabel} bridge ready`,"You can review the generated payload and submit the current config to /api/run.","success"),T(e.prefix,"history",!1),T(e.prefix,"recipes",!1),T(e.prefix,"presets",!1)}const Nn={overview:Tt,about:ps,settings:As,tasks:Ps,tageditor:Es,tensorboard:Ns,tools:Rs,"schema-bridge":ks,"sdxl-train":Is,"flux-train":fs,"sd3-train":$s,"sd3-finetune-train":_s,"dreambooth-train":hs,"flux-finetune-train":gs,"sd-controlnet-train":ws,"sdxl-controlnet-train":Ss,"flux-controlnet-train":ms,"sdxl-lllite-train":Ts,"sd-ti-train":xs,"xti-train":Ds,"sdxl-ti-train":Ls,"anima-train":us,"anima-finetune-train":ds,"lumina-train":vs,"lumina-finetune-train":ys,"hunyuan-image-train":bs};function Rn(e){const t={overview:j.filter(a=>a.section==="overview"),phase1:j.filter(a=>a.section==="phase1"),reference:j.filter(a=>a.section==="reference")};return`
    <div class="nav-group">
  ...
  `}async function Cn(e){e==="overview"?await Ta():e==="settings"?await Aa():e==="tasks"?await Wa():e==="tageditor"?await Na():e==="tools"?await Ra():e==="schema-bridge"?await ls(()=>{}):fe[e]&&await Pn(fe[e])}async function Dn(e){va();const t=ya(),a=Nn[t.id]??Tt;e.innerHTML=cs(t.hash,a());const n=document.querySelector("#side-nav");n&&(n.innerHTML=Rn(t.hash)),await Cn(t.id)}const Ct=document.querySelector("#app");if(!(Ct instanceof HTMLElement))throw new Error("App root not found.");const Bn=Ct;async function Dt(){await Dn(Bn)}window.addEventListener("hashchange",()=>{Dt()});Dt();
