...
a = Analysis(
    ...
    hiddenimports=['pywebview', 'launcher', 'launcher.main', 'launcher.config', 'launcher.i18n', 'launcher.api', 'launcher.window', 'launcher.core', 'launcher.core.launcher', 'launcher.core.installer', 'launcher.core.runtime_detector', 'launcher.core.settings', 'launcher.core.plugins', 'launcher.core.gpu', 'launcher.core.preflight', 'launcher.core.recommendation', 'launcher.core.api_result', 'launcher.core.compatibility', 'launcher.core.diagnostics', 'launcher.core.task_history_store', 'launcher.core.runtime_coordinator', 'launcher.core.runtime_catalog', 'launcher.core.runtime_tasks', 'launcher.core.task_executor', 'launcher.core.task_state', 'launcher.core.task_plans', 'launcher.core.update_checker', 'launcher.core.versioning'],
    hookspath=[],
    hooksconfig={},
    runtime_hooks=[],
    excludes=[],
